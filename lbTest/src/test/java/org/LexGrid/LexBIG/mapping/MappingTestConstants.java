...
public class MappingTestConstants {
	...
	public static String AUTHORING_SCHEME =  "Authoring_Test_Shell";
	public static String AUTHORING_VERSION = "1.1";
	public static String AUTHORING_URN = "http://authoring.test.shell";
	public static String RELATIONS_CONTAINER = "authoring_relations";
	public static String ASSOC_NAME_A = "original_type";
