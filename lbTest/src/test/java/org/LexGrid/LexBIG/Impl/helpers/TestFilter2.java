 ...
 * 'r' or m as their third letter in the entity descrition.
 * 
...
public class TestFilter2 implements Filter {
    ...
    public static String name_ = "JUnit Test Filter2";
    public static String version_ = "1.0";

    public boolean match(ResolvedConceptReference ref) {
        if(ref.getEntityDescription() == null || 
                ref.getEntityDescription().getContent() == null){
            return false;
        }
        return ref.getEntityDescription().getContent().charAt(2) == 'r'
                || ref.getEntityDescription().getContent().charAt(2) == 'm';
    }
