...
//        mainSuite.addTest(hl7MifVocabularyLoaderSuite);
        ...
        luceneSuite.addTest(TestSuite.createTest(SnowballAnalyzerTest.class, null));
        luceneSuite.addTest(TestSuite.createTest(StringAnalyzerTest.class, null));
        luceneSuite.addTest(TestSuite.createTest(WhiteSpaceLowerCaseAnalyzerTest.class, null));
