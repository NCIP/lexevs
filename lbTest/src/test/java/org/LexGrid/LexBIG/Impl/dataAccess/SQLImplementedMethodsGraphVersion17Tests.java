 ...
 */
public class SQLImplementedMethodsGraphVersion17Tests extends SQLImplementedMethodsGraphVersionTests {
    ...
    /* (non-Javadoc)
     * @see org.LexGrid.LexBIG.Impl.dataAccess.SQLImplementedMethodsGraphVersionTests#getTestID()
     */
    @Override
    protected String getTestID() {
       return "SQLImplementedMethodsGraph Table Version 1.7 Tests";
    } 
    
    /* (non-Javadoc)
     * @see org.LexGrid.LexBIG.Impl.dataAccess.SQLImplementedMethodsGraphVersionTests#setUp()
     */
