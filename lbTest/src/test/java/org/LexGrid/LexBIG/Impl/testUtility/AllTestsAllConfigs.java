...
import org.LexGrid.LexBIG.Impl.function.query.TestOrphanedConcept;
...
public class AllTestsAllConfigs {
    ...
    public static Test suite() throws Exception {
        ...
        for (int i = 0; i < configs.size(); i++) {
            TestSuite currentSuite = new TestSuite("Test for server config '" + configs.get(i).url + "' (Single DB - "
                    + configs.get(i).singleDBMode + ")");

            currentSuite.addTestSuite(ConfigureTest.class);
            currentSuite.addTestSuite(LoadTestDataTest.class);
            currentSuite.addTestSuite(LexBIGServiceConvenienceMethodsImplTest.class);
          
            currentSuite.addTestSuite(CodeToReturnTest.class);
            currentSuite.addTestSuite(NCIThesaurusHistoryServiceTest.class);
            currentSuite.addTestSuite(CodedNodeGraphImplTest.class);
            currentSuite.addTestSuite(CodedNodeSetImplTest.class);
            currentSuite.addTestSuite(ServiceManagerTest.class);

            currentSuite.addTestSuite(RegistryTest.class);
            currentSuite.addTestSuite(TestMetaDataSearch.class);
            ...
            currentSuite.addTestSuite(AbstractSortTest.class);
            currentSuite.addTestSuite(AbstractSearchTest.class);  
            ...
            currentSuite.addTest(luceneSuite);  
            ...
            currentSuite.addTest(luceneSearchSuite);
            ...
            currentSuite.addTest(codedNodeSetSuite);
            ...
            functionalTests.addTestSuite(TestPostLoadManifest.class);
            ...
            currentSuite.addTest(functionalTests);
            ...
            */
            ...
            currentSuite.addTest(metaLoaderSuite);
            ...
            currentSuite.addTest(umlsLoaderSuite);
            ...
            currentSuite.addTest(featureRequestTests);    

            currentSuite.addTestSuite(CleanUpTest.class);
            currentSuite.addTestSuite(CleanUpTest2.class);
        ...
        mainSuite.addTestSuite(FinalCleanUp.class);
