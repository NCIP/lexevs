 ...
 * 
 */
package org.LexGrid.LexBIG42.Impl.bugs;
...
public class TestBugFixes extends LexBIGServiceTestCase
{
    ...
    public void testNCISupportedAssociations() throws LBException
    {
        ...
        assertTrue(contains(sa, "hasSubtype"));
    ...
    {
        CodedNodeGraph cng = ServiceHolder.instance().getLexBIGService().getNodeGraph(THES_SCHEME, null, null);
        cng.restrictToAssociations(Constructors.createNameAndValueList("Anatomic_Structure_is_Physical_Part_of"), Constructors.createNameAndValueList("someValuesFrom"));
        ResolvedConceptReference[] rcr = cng.resolveAsList(Constructors.createConceptReference("C12223", null), 
