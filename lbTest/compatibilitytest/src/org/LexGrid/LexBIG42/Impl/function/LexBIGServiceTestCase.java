 ...
 * 
 */
package org.LexGrid.LexBIG42.Impl.function;
...
abstract public class LexBIGServiceTestCase extends TestCase {
	...
	protected final static String PARTS_SCHEME = "German Made Parts";
	protected final static String PARTS_URN = "urn:oid:11.11.0.2";
	protected final static String PARTS_VERSION = "2.0";
	protected final static String THES_SCHEME = "NCI_Thesaurus";
	...
	protected final static String META_URN = "urn:oid:2.16.840.1.113883.3.26.1.2";
	...
	protected final static String AIR_SCHEME = "AI/RHEUM";
	protected final static String AIR_URN = "urn:oid:2.16.840.1.113883.6.110";
	protected final static String AIR_VERSION = "1993.bvt";
