...
public class TestVersionChanges extends LexBIGServiceTestCase
{
    ...
    public void testT1_FNC_03() throws URISyntaxException, LBException
    {
        ...
        HistoryService hs = ServiceHolder.instance().getLexBIGService()
                .getHistoryService("http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl#");

        NCIChangeEvent[] nce = hs.getEditActionList(null, new URI("http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl#:05.11f"))
                .getEntry();
