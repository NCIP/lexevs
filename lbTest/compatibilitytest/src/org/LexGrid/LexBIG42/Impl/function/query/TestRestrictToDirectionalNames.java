...
public class TestRestrictToDirectionalNames extends LexBIGServiceTestCase
{
    ...
    public void testRestrictToDirectionalNames() throws LBException
    {
       ...
       // We have restricted to directional name develops_from, so is_a shouldn't be found.
       assertFalse(contains(a, "is_a", "CL:0000048"));  
       
       
       // Creating a CodedNodeGraph and restricting on directional names is_a and develops_from
       cng = ServiceHolder.instance().getLexBIGService().getNodeGraph(CELL_SCHEME, null, null);
       cng.restrictToDirectionalNames(Constructors.createNameAndValueList(new String[]{"is_a","develops_from"}), null);
       ...
       // check to see the convenience methods that helps determine directionality of the direction name for the association works.
