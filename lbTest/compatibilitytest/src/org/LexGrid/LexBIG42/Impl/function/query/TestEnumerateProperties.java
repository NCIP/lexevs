...
public class TestEnumerateProperties extends LexBIGServiceTestCase
{
     ...
     * 
     * @param code
     * @param ServiceHolder.instance().getLexBIGService()
     * @throws LBException
     */
    protected void enumerateProps(String code, String[] properties) throws LBException
    {
        ...
        ResolvedConceptReferenceList matches = ServiceHolder.instance().getLexBIGService()
    ...
    {
        enumerateProps("C12223", new String[] {"primitive", "Semantic_Type", "CONCEPT_NAME"});
    }

    public void testT1_FNC_29b() throws LBException
    {
        enumerateProps("C32223", new String[] {"primitive", "Semantic_Type", "CONCEPT_NAME"});
    }
