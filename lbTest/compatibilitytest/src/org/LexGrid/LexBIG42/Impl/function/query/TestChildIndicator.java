...
public class TestChildIndicator extends LexBIGServiceTestCase {
	...
	public void testT1_CHILD_INDICATOR() throws LBException {
		...
		ResolvedConceptReference[] rcr = cng.resolveAsList(Constructors.createConceptReference("CL:0000047", CELL_SCHEME),
				true, true, 2, 2, null, null, null, null, 0, true)
				.getResolvedConceptReference();
		//System.out.println(ObjectToString.toString(rcr)) ;
		...
		rcr = cng.resolveAsList(Constructors.createConceptReference("CL:0000047", CELL_SCHEME),
				true, true, 2, 2, null, null, null, null, 0, false)
				.getResolvedConceptReference();
		//System.out.println("==============================================") ;
		//System.out.println(ObjectToString.toString(rcr)) ;
		assertTrue(rcr[0].getConceptCode().equals("CL:0000047"));
...
//		CodedNodeGraph cng = ServiceHolder.instance().getLexBIGService().getNodeGraph("test", null, null);
//		ResolvedConceptReference[] rcr = cng.resolveAsList(
//				Constructors.createConceptReference("A", "test"), true, true, 2, 2, null, null, null, null,
//				0, true).getResolvedConceptReference();
//		System.out.println(ObjectToString.toString(rcr));
//		assertTrue(rcr[0].getConceptCode().equals("A"));
//
//		Association[] a = rcr[0].getTargetOf().getAssociation();
//
//
//		assertTrue(contains(a, "is_a", "A2"));
//
//		cng = ServiceHolder.instance().getLexBIGService().getNodeGraph("test", null, null);
//
//		rcr = cng.resolveAsList(Constructors.createConceptReference("A22", "test"), true, true, 2, 2, null,
//				null, null, null, 0, true).getResolvedConceptReference();
//		System.out.println("==============================================");
//		System.out.println(ObjectToString.toString(rcr));
//		assertTrue(rcr[0].getConceptCode().equals("A22"));
//
//		a = rcr[0].getSourceOf().getAssociation();
//
//		assertTrue(contains(a, "is_a", "A2"));
