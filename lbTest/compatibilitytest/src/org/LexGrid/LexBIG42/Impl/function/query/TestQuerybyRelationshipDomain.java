...
public class TestQuerybyRelationshipDomain extends LexBIGServiceTestCase
{
    ...
    public void testT1_FNC_10() throws LBException
    {
        ...
        String domainCode = "C43652";

        CodedNodeGraph cng = ServiceHolder.instance().getLexBIGService().getNodeGraph(THES_SCHEME, null, null);
        cng.restrictToAssociations(Constructors.createNameAndValueList("Role_Has_Domain"), null);
        ...
        ResolvedConceptReference[] rcr = cng
                .resolveAsList(Constructors.createConceptReference(domainCode, THES_SCHEME), true, false, -1, 2, null,
