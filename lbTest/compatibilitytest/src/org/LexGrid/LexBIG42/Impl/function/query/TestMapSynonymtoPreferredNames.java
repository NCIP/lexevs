...
public class TestMapSynonymtoPreferredNames extends LexBIGServiceTestCase
{
    ...
    public void testT1_FNC_38() throws LBException
    {
        ...
        ResolvedConceptReference[] rcr = cns.resolveToList(null, Constructors.createLocalNameList("CONCEPT_NAME"), null, 0)
                .getResolvedConceptReference();

        assertTrue(rcr.length == 1);
        assertTrue(rcr[0].getConceptCode().equals("C12788"));
        assertTrue(rcr[0].getReferencedEntry().getPropertyCount() == 1);
        assertTrue(rcr[0].getReferencedEntry().getProperty()[0].getValue().getContent()
                .equals("Skeletal_System"));
