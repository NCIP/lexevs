...
public class RxNormLoader extends LoadExportBaseShell {
    public RxNormLoader(LB_GUI lb_gui) {
        super(lb_gui);
        try {
            ...
            RxNormBatchLoader loader = (RxNormBatchLoader) lb_gui_.getLbs()
                    .getServiceManager(null)
                    .getLoader(RxNormBatchLoader.NAME);
    ...
    private void buildGUI(Shell shell, final RxNormBatchLoader loader) {
        ...
        load.addSelectionListener(new SelectionListener() {
            ...
            public void widgetSelected(SelectionEvent arg0) {
                ...
                try {
                    ...
                    try {
                        Thread loaderThread = new Thread(new RunRxnLoader(loader, uri, sab.getText()));
                        loaderThread.start();    
                    } catch (Exception e) {
    ...
    private class RunRxnLoader implements Runnable {

        private RxNormBatchLoader loader;
        private String sab;
        private URI uri;
        
        public RunRxnLoader(RxNormBatchLoader loader, URI uri, String sab){
            this.loader = loader;
            this.sab = sab;
            this.uri = uri;
        }
