...
/**
 * Content provider for the Coding Scheme Reference Contents SWT Table.
 * 
...
public class CodingSchemeReferenceContentProvider implements IStructuredContentProvider {
    ...
    public CodingSchemeReferenceContentProvider(LB_VSD_GUI lbVDGui, ValueSetDefinition vsd) {
        lbVDGui_ = lbVDGui;
        vsd_ = vsd;
    }
