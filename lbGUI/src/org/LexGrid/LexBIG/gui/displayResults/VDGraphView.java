...
public class VDGraphView extends JPanel {
    ...
    public VDGraphView(Composite parent, VDDisplayCodedNodeSet dcns) {
    ...
    public void init(Graph g, String label) {
        ...
        filter.add(new VDGraphViewFilter(graph, 2, this));
        ...
        FocusControl fc = new VDMyFocusControl(1, "filter", dcns);
