...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns0="http://LexGrid.org/schema/2009/01/LexGrid/codingSchemes" xmlns:ns1="http://LexGrid.org/schema/2009/01/LexGrid/commonTypes" xmlns:ns2="http://LexGrid.org/schema/2009/01/LexGrid/concepts" xmlns:ns3="http://LexGrid.org/schema/2009/01/LexGrid/naming" xmlns:ns4="http://LexGrid.org/schema/2009/01/LexGrid/relations" xmlns:tbf="http://www.altova.com/MapForce/UDF/tbf" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" exclude-result-prefixes="ns0 ns1 ns2 ns3 ns4 tbf xs fn">
	...
	<xsl:template match="/">
		<codingSchemes xmlns="http://LexGrid.org/schema/2010/01/LexGrid/codingSchemes" xmlns:lgBuiltin="http://LexGrid.org/schema/2010/01/LexGrid/builtins" xmlns:lgCommon="http://LexGrid.org/schema/2010/01/LexGrid/commonTypes" xmlns:lgCon="http://LexGrid.org/schema/2010/01/LexGrid/concepts" xmlns:lgNaming="http://LexGrid.org/schema/2010/01/LexGrid/naming" xmlns:lgRel="http://LexGrid.org/schema/2010/01/LexGrid/relations" xmlns:lgVD="http://LexGrid.org/schema/2010/01/LexGrid/valueSets" xmlns:lgVer="http://LexGrid.org/schema/2010/01/LexGrid/versions">
			<xsl:attribute name="xsi:schemaLocation" namespace="http://www.w3.org/2001/XMLSchema-instance" select="'http://LexGrid.org/schema/2010/01/LexGrid/codingSchemes C:/DOCUME~1/m039830/MYDOCU~1/Projects/NCI-LE~1.0/XML/2010/codingSchemes.xsd'"/>
			<xsl:for-each select="ns0:codingSchemes/ns0:codingScheme">
				...
				<xsl:variable name="var2_isActive" as="item()*" select="@isActive"/>
				<xsl:variable name="var3_formalName" as="item()*" select="@formalName"/>
				<xsl:variable name="var4_expirationDate" as="item()*" select="@expirationDate"/>
				<xsl:variable name="var5_effectiveDate" as="item()*" select="@effectiveDate"/>
				<xsl:variable name="var6_status" as="item()*" select="@status"/>
				<xsl:variable name="var7_approxNumConcepts" as="item()*" select="@approxNumConcepts"/>
				<xsl:variable name="var8_relations" as="node()*" select="ns0:relations"/>
				<xsl:variable name="var9_mappings" as="node()" select="ns0:mappings"/>
				<codingScheme>
					<xsl:if test="fn:exists($var2_isActive)">
						<xsl:attribute name="isActive" namespace="" select="xs:string(xs:boolean(fn:string($var2_isActive)))"/>
					</xsl:if>
					<xsl:if test="fn:exists($var6_status)">
						<xsl:attribute name="status" namespace="" select="fn:string($var6_status)"/>
					</xsl:if>
					...
					<xsl:if test="fn:exists($var4_expirationDate)">
						<xsl:attribute name="expirationDate" namespace="" select="xs:string(xs:dateTime(fn:string($var4_expirationDate)))"/>
					</xsl:if>
					...
					<xsl:if test="fn:exists($var3_formalName)">
						<xsl:attribute name="formalName" namespace="" select="fn:string($var3_formalName)"/>
					</xsl:if>
					...
					<xsl:if test="fn:exists($var7_approxNumConcepts)">
						<xsl:attribute name="approxNumConcepts" namespace="" select="xs:string(xs:integer(fn:string($var7_approxNumConcepts)))"/>
					</xsl:if>
					...
					<xsl:for-each select="ns0:properties">
						<properties>
							<xsl:for-each select="ns1:property">
								<xsl:variable name="var12_language" as="item()*" select="@language"/>
								<xsl:variable name="var13_expirationDate" as="item()*" select="@expirationDate"/>
								<xsl:variable name="var14_isActive" as="item()*" select="@isActive"/>
								<xsl:variable name="var15_propertyType" as="item()*" select="@propertyType"/>
								<xsl:variable name="var16_status" as="item()*" select="@status"/>
								<xsl:variable name="var17_propertyId" as="item()*" select="@propertyId"/>
								<xsl:variable name="var18_effectiveDate" as="item()*" select="@effectiveDate"/>
								<lgCommon:property xsl:exclude-result-prefixes="lgCommon">
									<xsl:if test="fn:exists($var14_isActive)">
										<xsl:attribute name="isActive" namespace="" select="xs:string(xs:boolean(fn:string($var14_isActive)))"/>
									</xsl:if>
									<xsl:if test="fn:exists($var16_status)">
										<xsl:attribute name="status" namespace="" select="fn:string($var16_status)"/>
									</xsl:if>
									<xsl:if test="fn:exists($var18_effectiveDate)">
										<xsl:attribute name="effectiveDate" namespace="" select="xs:string(xs:dateTime(fn:string($var18_effectiveDate)))"/>
									</xsl:if>
									<xsl:if test="fn:exists($var13_expirationDate)">
										<xsl:attribute name="expirationDate" namespace="" select="xs:string(xs:dateTime(fn:string($var13_expirationDate)))"/>
									</xsl:if>
									<xsl:attribute name="propertyName" namespace="" select="fn:string(@propertyName)"/>
									<xsl:if test="fn:exists($var17_propertyId)">
										<xsl:attribute name="propertyId" namespace="" select="fn:string($var17_propertyId)"/>
									</xsl:if>
									<xsl:if test="fn:exists($var15_propertyType)">
										<xsl:attribute name="propertyType" namespace="" select="fn:string($var15_propertyType)"/>
									</xsl:if>
									<xsl:if test="fn:exists($var12_language)">
										<xsl:attribute name="language" namespace="" select="fn:string($var12_language)"/>
									</xsl:if>
									<xsl:for-each select="ns1:owner">
										<lgCommon:owner xsl:exclude-result-prefixes="lgCommon">
											<xsl:sequence select="fn:string(.)"/>
					...
					<xsl:for-each select="ns0:entities">
						<entities>
							<xsl:for-each select="ns2:entity">
								<xsl:variable name="var20_status" as="item()*" select="@status"/>
								<xsl:variable name="var21_expirationDate" as="item()*" select="@expirationDate"/>
								<xsl:variable name="var22_entityCodeNamespace" as="item()*" select="@entityCodeNamespace"/>
								<xsl:variable name="var23_isAnonymous" as="item()*" select="@isAnonymous"/>
								<xsl:variable name="var24_effectiveDate" as="item()*" select="@effectiveDate"/>
								...
								<lgCon:entity xsl:exclude-result-prefixes="lgCon">
									...
									<xsl:if test="fn:exists($var20_status)">
										<xsl:attribute name="status" namespace="" select="fn:string($var20_status)"/>
									</xsl:if>
									<xsl:if test="fn:exists($var24_effectiveDate)">
										<xsl:attribute name="effectiveDate" namespace="" select="xs:string(xs:dateTime(fn:string($var24_effectiveDate)))"/>
									</xsl:if>
									<xsl:if test="fn:exists($var21_expirationDate)">
										<xsl:attribute name="expirationDate" namespace="" select="xs:string(xs:dateTime(fn:string($var21_expirationDate)))"/>
									</xsl:if>
									<xsl:attribute name="entityCode" namespace="" select="fn:string(@entityCode)"/>
									<xsl:if test="fn:exists($var22_entityCodeNamespace)">
										<xsl:attribute name="entityCodeNamespace" namespace="" select="fn:string($var22_entityCodeNamespace)"/>
									</xsl:if>
									<xsl:if test="fn:exists($var23_isAnonymous)">
										<xsl:attribute name="isAnonymous" namespace="" select="xs:string(xs:boolean(fn:string($var23_isAnonymous)))"/>
									</xsl:if>
									...
									<xsl:for-each select="ns2:presentation">
										<xsl:variable name="var27_degreeOfFidelity" as="item()*" select="@degreeOfFidelity"/>
										<xsl:variable name="var28_propertyId" as="item()*" select="@propertyId"/>
										<xsl:variable name="var29_effectiveDate" as="item()*" select="@effectiveDate"/>
										<xsl:variable name="var30_propertyType" as="item()*" select="@propertyType"/>
										<xsl:variable name="var31_matchIfNoContext" as="item()*" select="@matchIfNoContext"/>
										<xsl:variable name="var32_isPreferred" as="item()*" select="@isPreferred"/>
										<xsl:variable name="var33_representationalForm" as="item()*" select="@representationalForm"/>
										<xsl:variable name="var34_status" as="item()*" select="@status"/>
										<xsl:variable name="var35_expirationDate" as="item()*" select="@expirationDate"/>
										<xsl:variable name="var36_isActive" as="item()*" select="@isActive"/>
										<xsl:variable name="var37_language" as="item()*" select="@language"/>
										<lgCon:presentation xsl:exclude-result-prefixes="lgCon">
											<xsl:if test="fn:exists($var36_isActive)">
												<xsl:attribute name="isActive" namespace="" select="xs:string(xs:boolean(fn:string($var36_isActive)))"/>
											</xsl:if>
											<xsl:if test="fn:exists($var34_status)">
												<xsl:attribute name="status" namespace="" select="fn:string($var34_status)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var29_effectiveDate)">
												<xsl:attribute name="effectiveDate" namespace="" select="xs:string(xs:dateTime(fn:string($var29_effectiveDate)))"/>
											</xsl:if>
											...
											<xsl:attribute name="propertyName" namespace="" select="fn:string(@propertyName)"/>
											<xsl:if test="fn:exists($var28_propertyId)">
												<xsl:attribute name="propertyId" namespace="" select="fn:string($var28_propertyId)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var30_propertyType)">
												<xsl:attribute name="propertyType" namespace="" select="fn:string($var30_propertyType)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var37_language)">
												<xsl:attribute name="language" namespace="" select="fn:string($var37_language)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var32_isPreferred)">
												<xsl:attribute name="isPreferred" namespace="" select="xs:string(xs:boolean(fn:string($var32_isPreferred)))"/>
											</xsl:if>
											<xsl:if test="fn:exists($var27_degreeOfFidelity)">
												<xsl:attribute name="degreeOfFidelity" namespace="" select="fn:string($var27_degreeOfFidelity)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var31_matchIfNoContext)">
												<xsl:attribute name="matchIfNoContext" namespace="" select="xs:string(xs:boolean(fn:string($var31_matchIfNoContext)))"/>
											</xsl:if>
											<xsl:if test="fn:exists($var33_representationalForm)">
												<xsl:attribute name="representationalForm" namespace="" select="fn:string($var33_representationalForm)"/>
											</xsl:if>
											<xsl:for-each select="ns1:owner">
												<lgCommon:owner xsl:exclude-result-prefixes="lgCommon">
													<xsl:sequence select="fn:string(.)"/>
									...
									<xsl:for-each select="ns2:definition">
										...
										<xsl:variable name="var42_effectiveDate" as="item()*" select="@effectiveDate"/>
										<xsl:variable name="var43_status" as="item()*" select="@status"/>
										<xsl:variable name="var44_propertyId" as="item()*" select="@propertyId"/>
										<xsl:variable name="var45_isPreferred" as="item()*" select="@isPreferred"/>
										<xsl:variable name="var46_isActive" as="item()*" select="@isActive"/>
										<lgCon:definition xsl:exclude-result-prefixes="lgCon">
											<xsl:if test="fn:exists($var46_isActive)">
												<xsl:attribute name="isActive" namespace="" select="xs:string(xs:boolean(fn:string($var46_isActive)))"/>
											</xsl:if>
											<xsl:if test="fn:exists($var43_status)">
												<xsl:attribute name="status" namespace="" select="fn:string($var43_status)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var42_effectiveDate)">
												<xsl:attribute name="effectiveDate" namespace="" select="xs:string(xs:dateTime(fn:string($var42_effectiveDate)))"/>
											</xsl:if>
											...
											<xsl:attribute name="propertyName" namespace="" select="fn:string(@propertyName)"/>
											<xsl:if test="fn:exists($var44_propertyId)">
												<xsl:attribute name="propertyId" namespace="" select="fn:string($var44_propertyId)"/>
											</xsl:if>
											...
											<xsl:if test="fn:exists($var45_isPreferred)">
												<xsl:attribute name="isPreferred" namespace="" select="xs:string(xs:boolean(fn:string($var45_isPreferred)))"/>
											</xsl:if>
											<xsl:for-each select="ns1:owner">
												<lgCommon:owner xsl:exclude-result-prefixes="lgCommon">
													<xsl:sequence select="fn:string(.)"/>
									...
									<xsl:for-each select="ns2:comment">
										<xsl:variable name="var48_language" as="item()*" select="@language"/>
										...
										<xsl:variable name="var52_status" as="item()*" select="@status"/>
										<xsl:variable name="var53_effectiveDate" as="item()*" select="@effectiveDate"/>
										<xsl:variable name="var54_propertyId" as="item()*" select="@propertyId"/>
										<lgCon:comment xsl:exclude-result-prefixes="lgCon">
											...
											<xsl:if test="fn:exists($var52_status)">
												<xsl:attribute name="status" namespace="" select="fn:string($var52_status)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var53_effectiveDate)">
												<xsl:attribute name="effectiveDate" namespace="" select="xs:string(xs:dateTime(fn:string($var53_effectiveDate)))"/>
											</xsl:if>
											...
											<xsl:attribute name="propertyName" namespace="" select="fn:string(@propertyName)"/>
											<xsl:if test="fn:exists($var54_propertyId)">
												<xsl:attribute name="propertyId" namespace="" select="fn:string($var54_propertyId)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var51_propertyType)">
												<xsl:attribute name="propertyType" namespace="" select="fn:string($var51_propertyType)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var48_language)">
												<xsl:attribute name="language" namespace="" select="fn:string($var48_language)"/>
											</xsl:if>
											<xsl:for-each select="ns1:owner">
												<lgCommon:owner xsl:exclude-result-prefixes="lgCommon">
													<xsl:sequence select="fn:string(.)"/>
									...
									<xsl:for-each select="ns2:property">
										<xsl:variable name="var56_status" as="item()*" select="@status"/>
										...
										<xsl:variable name="var60_expirationDate" as="item()*" select="@expirationDate"/>
										<xsl:variable name="var61_effectiveDate" as="item()*" select="@effectiveDate"/>
										<xsl:variable name="var62_propertyId" as="item()*" select="@propertyId"/>
										<lgCon:property xsl:exclude-result-prefixes="lgCon">
											...
											<xsl:if test="fn:exists($var56_status)">
												<xsl:attribute name="status" namespace="" select="fn:string($var56_status)"/>
											</xsl:if>
											...
											<xsl:if test="fn:exists($var60_expirationDate)">
												<xsl:attribute name="expirationDate" namespace="" select="xs:string(xs:dateTime(fn:string($var60_expirationDate)))"/>
											</xsl:if>
											<xsl:attribute name="propertyName" namespace="" select="fn:string(@propertyName)"/>
											<xsl:if test="fn:exists($var62_propertyId)">
												<xsl:attribute name="propertyId" namespace="" select="fn:string($var62_propertyId)"/>
											</xsl:if>
							...
							<xsl:for-each select="$var8_relations/ns4:association">
								<xsl:variable name="var64_forwardName" as="item()*" select="@forwardName"/>
								<xsl:variable name="var65_isActive" as="item()*" select="@isActive"/>
								<xsl:variable name="var66_isAnonymous" as="item()*" select="@isAnonymous"/>
								<xsl:variable name="var67_isDefined" as="item()*" select="@isDefined"/>
								<xsl:variable name="var68_effectiveDate" as="item()*" select="@effectiveDate"/>
								<xsl:variable name="var69_status" as="item()*" select="@status"/>
								<xsl:variable name="var70_isNavigable" as="item()*" select="@isNavigable"/>
								<xsl:variable name="var71_entityCodeNamespace" as="item()*" select="@entityCodeNamespace"/>
								<xsl:variable name="var72_expirationDate" as="item()*" select="@expirationDate"/>
								<xsl:variable name="var73_reverseName" as="item()*" select="@reverseName"/>
								<xsl:variable name="var74_isTransitive" as="item()*" select="@isTransitive"/>
								<lgCon:associationEntity xsl:exclude-result-prefixes="lgCon">
									<xsl:if test="fn:exists($var65_isActive)">
										<xsl:attribute name="isActive" namespace="" select="xs:string(xs:boolean(fn:string($var65_isActive)))"/>
									</xsl:if>
									<xsl:if test="fn:exists($var69_status)">
										<xsl:attribute name="status" namespace="" select="fn:string($var69_status)"/>
									</xsl:if>
									<xsl:if test="fn:exists($var68_effectiveDate)">
										<xsl:attribute name="effectiveDate" namespace="" select="xs:string(xs:dateTime(fn:string($var68_effectiveDate)))"/>
									</xsl:if>
									<xsl:if test="fn:exists($var72_expirationDate)">
										<xsl:attribute name="expirationDate" namespace="" select="xs:string(xs:dateTime(fn:string($var72_expirationDate)))"/>
									</xsl:if>
									<xsl:attribute name="entityCode" namespace="" select="fn:string(@entityCode)"/>
									...
									<xsl:if test="fn:exists($var66_isAnonymous)">
										<xsl:attribute name="isAnonymous" namespace="" select="xs:string(xs:boolean(fn:string($var66_isAnonymous)))"/>
									</xsl:if>
									<xsl:if test="fn:exists($var67_isDefined)">
										<xsl:attribute name="isDefined" namespace="" select="xs:string(xs:boolean(fn:string($var67_isDefined)))"/>
									</xsl:if>
									<xsl:if test="fn:exists($var64_forwardName)">
										<xsl:attribute name="forwardName" namespace="" select="fn:string($var64_forwardName)"/>
									</xsl:if>
									<xsl:if test="fn:exists($var73_reverseName)">
										<xsl:attribute name="reverseName" namespace="" select="fn:string($var73_reverseName)"/>
									</xsl:if>
									<xsl:if test="fn:exists($var70_isNavigable)">
										<xsl:attribute name="isNavigable" namespace="" select="xs:string(xs:boolean(fn:string($var70_isNavigable)))"/>
									</xsl:if>
									<xsl:if test="fn:exists($var74_isTransitive)">
										<xsl:attribute name="isTransitive" namespace="" select="xs:string(xs:boolean(fn:string($var74_isTransitive)))"/>
									</xsl:if>
									<xsl:for-each select="ns1:owner">
										<lgCommon:owner xsl:exclude-result-prefixes="lgCommon">
											<xsl:sequence select="fn:string(.)"/>
									...
									<xsl:for-each select="ns2:presentation">
										<xsl:variable name="var75_propertyType" as="item()*" select="@propertyType"/>
										<xsl:variable name="var76_effectiveDate" as="item()*" select="@effectiveDate"/>
										<xsl:variable name="var77_representationalForm" as="item()*" select="@representationalForm"/>
										<xsl:variable name="var78_degreeOfFidelity" as="item()*" select="@degreeOfFidelity"/>
										<xsl:variable name="var79_language" as="item()*" select="@language"/>
										<xsl:variable name="var80_matchIfNoContext" as="item()*" select="@matchIfNoContext"/>
										<xsl:variable name="var81_isActive" as="item()*" select="@isActive"/>
										<xsl:variable name="var82_expirationDate" as="item()*" select="@expirationDate"/>
										<xsl:variable name="var83_status" as="item()*" select="@status"/>
										<xsl:variable name="var84_isPreferred" as="item()*" select="@isPreferred"/>
										<xsl:variable name="var85_propertyId" as="item()*" select="@propertyId"/>
										<lgCon:presentation xsl:exclude-result-prefixes="lgCon">
											<xsl:if test="fn:exists($var81_isActive)">
												<xsl:attribute name="isActive" namespace="" select="xs:string(xs:boolean(fn:string($var81_isActive)))"/>
											</xsl:if>
											<xsl:if test="fn:exists($var83_status)">
												<xsl:attribute name="status" namespace="" select="fn:string($var83_status)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var76_effectiveDate)">
												<xsl:attribute name="effectiveDate" namespace="" select="xs:string(xs:dateTime(fn:string($var76_effectiveDate)))"/>
											</xsl:if>
											...
											<xsl:if test="fn:exists($var75_propertyType)">
												<xsl:attribute name="propertyType" namespace="" select="fn:string($var75_propertyType)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var79_language)">
												<xsl:attribute name="language" namespace="" select="fn:string($var79_language)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var84_isPreferred)">
												<xsl:attribute name="isPreferred" namespace="" select="xs:string(xs:boolean(fn:string($var84_isPreferred)))"/>
											</xsl:if>
											<xsl:if test="fn:exists($var78_degreeOfFidelity)">
												<xsl:attribute name="degreeOfFidelity" namespace="" select="fn:string($var78_degreeOfFidelity)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var80_matchIfNoContext)">
												<xsl:attribute name="matchIfNoContext" namespace="" select="xs:string(xs:boolean(fn:string($var80_matchIfNoContext)))"/>
											</xsl:if>
											<xsl:if test="fn:exists($var77_representationalForm)">
												<xsl:attribute name="representationalForm" namespace="" select="fn:string($var77_representationalForm)"/>
											</xsl:if>
											<xsl:for-each select="ns1:owner">
												<lgCommon:owner xsl:exclude-result-prefixes="lgCommon">
													<xsl:sequence select="fn:string(.)"/>
									...
									<xsl:for-each select="ns2:definition">
										...
										<xsl:variable name="var89_status" as="item()*" select="@status"/>
										<xsl:variable name="var90_effectiveDate" as="item()*" select="@effectiveDate"/>
										<xsl:variable name="var91_propertyType" as="item()*" select="@propertyType"/>
										<xsl:variable name="var92_isActive" as="item()*" select="@isActive"/>
										<xsl:variable name="var93_expirationDate" as="item()*" select="@expirationDate"/>
										<xsl:variable name="var94_propertyId" as="item()*" select="@propertyId"/>
										<lgCon:definition xsl:exclude-result-prefixes="lgCon">
											<xsl:if test="fn:exists($var92_isActive)">
												<xsl:attribute name="isActive" namespace="" select="xs:string(xs:boolean(fn:string($var92_isActive)))"/>
											</xsl:if>
											<xsl:if test="fn:exists($var89_status)">
												<xsl:attribute name="status" namespace="" select="fn:string($var89_status)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var90_effectiveDate)">
												<xsl:attribute name="effectiveDate" namespace="" select="xs:string(xs:dateTime(fn:string($var90_effectiveDate)))"/>
											</xsl:if>
											<xsl:if test="fn:exists($var93_expirationDate)">
												<xsl:attribute name="expirationDate" namespace="" select="xs:string(xs:dateTime(fn:string($var93_expirationDate)))"/>
											</xsl:if>
											<xsl:attribute name="propertyName" namespace="" select="fn:string(@propertyName)"/>
											<xsl:if test="fn:exists($var94_propertyId)">
												<xsl:attribute name="propertyId" namespace="" select="fn:string($var94_propertyId)"/>
											</xsl:if>
									...
									<xsl:for-each select="ns2:comment">
										<xsl:variable name="var96_isActive" as="item()*" select="@isActive"/>
										<xsl:variable name="var97_expirationDate" as="item()*" select="@expirationDate"/>
										<xsl:variable name="var98_status" as="item()*" select="@status"/>
										...
										<xsl:variable name="var102_propertyId" as="item()*" select="@propertyId"/>
										<lgCon:comment xsl:exclude-result-prefixes="lgCon">
											<xsl:if test="fn:exists($var96_isActive)">
												<xsl:attribute name="isActive" namespace="" select="xs:string(xs:boolean(fn:string($var96_isActive)))"/>
											</xsl:if>
											<xsl:if test="fn:exists($var98_status)">
												<xsl:attribute name="status" namespace="" select="fn:string($var98_status)"/>
											</xsl:if>
											...
											<xsl:if test="fn:exists($var97_expirationDate)">
												<xsl:attribute name="expirationDate" namespace="" select="xs:string(xs:dateTime(fn:string($var97_expirationDate)))"/>
											</xsl:if>
											<xsl:attribute name="propertyName" namespace="" select="fn:string(@propertyName)"/>
											<xsl:if test="fn:exists($var102_propertyId)">
												<xsl:attribute name="propertyId" namespace="" select="fn:string($var102_propertyId)"/>
											</xsl:if>
									...
									<xsl:for-each select="ns2:property">
										<xsl:variable name="var104_effectiveDate" as="item()*" select="@effectiveDate"/>
										<xsl:variable name="var105_propertyType" as="item()*" select="@propertyType"/>
										<xsl:variable name="var106_isActive" as="item()*" select="@isActive"/>
										<xsl:variable name="var107_expirationDate" as="item()*" select="@expirationDate"/>
										<xsl:variable name="var108_status" as="item()*" select="@status"/>
										<xsl:variable name="var109_propertyId" as="item()*" select="@propertyId"/>
										<xsl:variable name="var110_language" as="item()*" select="@language"/>
										<lgCon:property xsl:exclude-result-prefixes="lgCon">
											...
											<xsl:if test="fn:exists($var104_effectiveDate)">
												<xsl:attribute name="effectiveDate" namespace="" select="xs:string(xs:dateTime(fn:string($var104_effectiveDate)))"/>
											</xsl:if>
											<xsl:if test="fn:exists($var107_expirationDate)">
												<xsl:attribute name="expirationDate" namespace="" select="xs:string(xs:dateTime(fn:string($var107_expirationDate)))"/>
											</xsl:if>
											<xsl:attribute name="propertyName" namespace="" select="fn:string(@propertyName)"/>
											<xsl:if test="fn:exists($var109_propertyId)">
												<xsl:attribute name="propertyId" namespace="" select="fn:string($var109_propertyId)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var105_propertyType)">
												<xsl:attribute name="propertyType" namespace="" select="fn:string($var105_propertyType)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var110_language)">
												<xsl:attribute name="language" namespace="" select="fn:string($var110_language)"/>
											</xsl:if>
											<xsl:for-each select="ns1:owner">
												<lgCommon:owner xsl:exclude-result-prefixes="lgCommon">
													<xsl:sequence select="fn:string(.)"/>
									...
									<xsl:for-each select="ns4:source">
										...
										<lgRel:source xsl:exclude-result-prefixes="lgRel">
											...
											<xsl:for-each select="ns4:target">
												<xsl:variable name="var114_expirationDate" as="item()*" select="@expirationDate"/>
												<xsl:variable name="var115_effectiveDate" as="item()*" select="@effectiveDate"/>
												<xsl:variable name="var116_isActive" as="item()*" select="@isActive"/>
												<xsl:variable name="var117_targetEntityCodeNamespace" as="item()*" select="@targetEntityCodeNamespace"/>
												<xsl:variable name="var118_associationInstanceId" as="item()*" select="@associationInstanceId"/>
												<xsl:variable name="var119_isDefining" as="item()*" select="@isDefining"/>
												<xsl:variable name="var120_isInferred" as="item()*" select="@isInferred"/>
												<xsl:variable name="var121_status" as="item()*" select="@status"/>
												<lgRel:target xsl:exclude-result-prefixes="lgRel">
													<xsl:if test="fn:exists($var116_isActive)">
														<xsl:attribute name="isActive" namespace="" select="xs:string(xs:boolean(fn:string($var116_isActive)))"/>
													</xsl:if>
													<xsl:if test="fn:exists($var121_status)">
														<xsl:attribute name="status" namespace="" select="fn:string($var121_status)"/>
													</xsl:if>
													<xsl:if test="fn:exists($var115_effectiveDate)">
														<xsl:attribute name="effectiveDate" namespace="" select="xs:string(xs:dateTime(fn:string($var115_effectiveDate)))"/>
													</xsl:if>
													<xsl:if test="fn:exists($var114_expirationDate)">
														<xsl:attribute name="expirationDate" namespace="" select="xs:string(xs:dateTime(fn:string($var114_expirationDate)))"/>
													</xsl:if>
													<xsl:if test="fn:exists($var118_associationInstanceId)">
														<xsl:attribute name="associationInstanceId" namespace="" select="fn:string($var118_associationInstanceId)"/>
													</xsl:if>
													<xsl:if test="fn:exists($var120_isInferred)">
														<xsl:attribute name="isInferred" namespace="" select="xs:string(xs:boolean(fn:string($var120_isInferred)))"/>
													</xsl:if>
													<xsl:if test="fn:exists($var119_isDefining)">
														<xsl:attribute name="isDefining" namespace="" select="xs:string(xs:boolean(fn:string($var119_isDefining)))"/>
													</xsl:if>
													<xsl:attribute name="targetEntityCode" namespace="" select="fn:string(@targetEntityCode)"/>
													<xsl:if test="fn:exists($var117_targetEntityCodeNamespace)">
														<xsl:attribute name="targetEntityCodeNamespace" namespace="" select="fn:string($var117_targetEntityCodeNamespace)"/>
													</xsl:if>
													<xsl:for-each select="ns1:owner">
														<lgCommon:owner xsl:exclude-result-prefixes="lgCommon">
															<xsl:sequence select="fn:string(.)"/>
											...
											<xsl:for-each select="ns4:targetData">
												<xsl:variable name="var122_effectiveDate" as="item()*" select="@effectiveDate"/>
												<xsl:variable name="var123_associationInstanceId" as="item()*" select="@associationInstanceId"/>
												...
												<lgRel:targetData xsl:exclude-result-prefixes="lgRel">
													...
													<xsl:if test="fn:exists($var122_effectiveDate)">
														<xsl:attribute name="effectiveDate" namespace="" select="xs:string(xs:dateTime(fn:string($var122_effectiveDate)))"/>
													</xsl:if>
													...
													<xsl:if test="fn:exists($var123_associationInstanceId)">
														<xsl:attribute name="associationInstanceId" namespace="" select="fn:string($var123_associationInstanceId)"/>
													</xsl:if>
