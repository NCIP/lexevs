...
import org.LexGrid.LexBIG.Impl.internalExceptions.InitializationException;
...
public class IndexInterface {
    ...
    public IndexInterface(String location) throws InitializationException, LBInvocationException {
        try {
            ...
            throw new InitializationException("There was an unexpected error while initializing the index service at "
                    + location, e);
        } catch (Exception e) {
            throw new InitializationException("There was an unexpected error while initializing the index service at "
                    + location, e);
    ...
    protected void initCodingSchemes() throws LBInvocationException, UnexpectedInternalError {
        ...
        try {
            ...
            throw new UnexpectedInternalError("There was a problem reading the index metadata.", e);
        }
    }
    ...
    public DocIdSetIterator getBoundaryDocumentIterator(String internalCodeSystemName, String internalVersionString) throws MissingResourceException, UnexpectedInternalError{
        ...
        if(!boundryDocIdSetMap.containsKey(indexName)){
            try {
                ...
                throw new UnexpectedInternalError("There was a problem initializing the index.", e);
            } 
        }
    ...
    public LuceneIndexReader getIndexReader(String internalCodeSystemName, String internalVersionString)
        ...
        try {
            ...
            throw new MissingResourceException("There was an error opening the index for " + internalCodeSystemName
    ...
    public LuceneIndexReader getMetaDataIndexReader() throws MissingResourceException {
        String indexName = SystemVariables.getMetaDataIndexName();
        LuceneIndexReader lir = (LuceneIndexReader) indexReaders_.get(indexName);
        ...
        try {
            ...
            throw new MissingResourceException("There was an error opening the index for the MetaData Index", e);
        } catch (InternalIndexerErrorException e) {
            throw new MissingResourceException("There was an error opening the index for the MetaData Index", e);
        }
    }

    public void reopenIndex(String internalCodeSystemName, String internalVersionString)
            throws MissingResourceException, LBInvocationException {
    ...
    public SearchServiceInterface getSearcher(String internalCodeSystemName, String internalVersionString)
        ...
        try {
            ...
            throw new MissingResourceException("There was an error opening the index searcher for "
    ...
    public SearchServiceInterface getMetaDataSearcher() throws MissingResourceException {
        String indexName = SystemVariables.getMetaDataIndexName();
        ...
        try {
            ...
            throw new MissingResourceException("There was an error opening the metadata index searcher", e);
        } catch (InternalIndexerErrorException e) {
            throw new MissingResourceException("There was an error opening the metadata index searcher.", e);
        }
    }

    protected void deleteIndex(String internalCodeSystemName, String internalVersionString) throws InternalException {
        try {
            LocalCodingScheme lcs = new LocalCodingScheme();
    ...
    private String mapCodeSystemToIndexName(String internalCodeSystemName, String internalVersionString)
        ...
        if (indexName == null) {
            throw new MissingResourceException("The index for the code system " + internalCodeSystemName
                    + " is not available.");
        }
        return indexName;
    }

    public String getMetaLocation() throws UnexpectedInternalError {
        try {
            return service_.getMetaData().getMetaLocation();
        } catch (IOException e) {
            throw new UnexpectedInternalError("Unexpected Error", e);
        }
    }
