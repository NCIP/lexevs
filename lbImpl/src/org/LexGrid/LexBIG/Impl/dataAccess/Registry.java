...
public class Registry {
    ...
    protected synchronized void setDeactivateDate(AbsoluteCodingSchemeVersionReference acsvr, Date date)
    ...
    protected synchronized void deactivate(DBEntry entry) throws LBInvocationException, LBParameterException {
        WriteLockManager.instance().lockLockFile();
        WriteLockManager.instance().checkForRegistryUpdates();
        try {
            // go through the instance method to get the new Registry object (if
    ...
    protected synchronized void setStatusPending(DBEntry entry) throws LBInvocationException, LBParameterException {
        WriteLockManager.instance().lockLockFile();
        WriteLockManager.instance().checkForRegistryUpdates();
        try {
            // go through the instance method to get the new Registry object (if
    ...
    protected synchronized void updateTag(AbsoluteCodingSchemeVersionReference codingScheme, String newTag)
    ...
    protected synchronized void updateVersion(AbsoluteCodingSchemeVersionReference codingScheme, String newVersion)
            throws LBInvocationException, LBParameterException {
        WriteLockManager.instance().lockLockFile();
        WriteLockManager.instance().checkForRegistryUpdates();
        try {
    ...
    protected DBEntry getEntry(AbsoluteCodingSchemeVersionReference codingScheme) throws LBParameterException {
    ...
    protected Registry(String pathToRegistryFile) throws Exception {
    ...
    protected synchronized void remove(AbsoluteCodingSchemeVersionReference codingSchemeVersion)
    ...
    protected HistoryEntry getHistoryEntry(String urn) throws LBParameterException {
        for (int i = 0; i < historyEntries_.size(); i++) {
            if (historyEntries_.get(i).urn.equals(urn)) {
     ...
     * @throws LBParameterException
     */
    protected synchronized void removeHistoryEntry(String urn) throws InternalException, LBInvocationException,
            LBParameterException {
        WriteLockManager.instance().lockLockFile();
        WriteLockManager.instance().checkForRegistryUpdates();
        try {
