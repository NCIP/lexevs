...
public class SQLInterface {
    ...
    protected SQLInterface(SQLInterfaceBase sib, String tablePrefix) throws InitializationException {
        try {
            sib_ = sib;
            ...
            throw new InitializationException("Problem setting up the SQLInterface", e);
        }
    }
