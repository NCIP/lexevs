...
public class SystemVariables {
    ...
    private Properties loadPropsFile(Logger logger) throws Exception {
        try {
            // set the logger so warnings and errors get captured.
            PropertiesUtility.logger = logger;
    ...
    protected SystemVariables(Logger logger) throws Exception {
        Properties props = loadPropsFile(logger);
        init(logger, props);
    }

    protected SystemVariables(Logger logger, Properties props) throws Exception {
        init(logger, props);
    }
    ...
    protected Hashtable<String, SQLConnectionInfo> getSqlServers() {
        return sqlServers_;
    }

    protected HashSet<String> getIndexLocations() {
