...
public class SQLInterfaceBase extends JDBCBaseService {
    ...
    protected SQLInterfaceBase(String username, String password, String url, String driver)
        ...
        try {
            ...
            try {
                ...
                throw new InitializationException("The driver for your sql connection was not found.  I tried to load "
                        + driver);
            }
            ...
            throw new InitializationException("There was a problem initializing the connection to " + url, e);
        }
    }
