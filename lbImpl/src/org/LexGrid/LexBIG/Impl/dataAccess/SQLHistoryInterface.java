...
public class SQLHistoryInterface {
    ...
    protected SQLHistoryInterface(SQLInterfaceBase sib, String tablePrefix) throws InitializationException {
        try {
            sib_ = sib;
            ...
            throw new InitializationException("Problem stting up the SQLInterface", e);
        }
    }
