...
public class SQLImplementedMethods {
    ...
    public static Entity buildCodedEntry(String internalCodingSchemeName, String internalVersionString,
        ...
        try {   
            ...
            try {
                ...
                if (si.isAccess()) // If DB is MS Access
                {
                    // access insists on more parenthesis here, not sure why.
    ...
    public static CodingScheme buildCodingScheme(String internalCodingSchemeName, String internalVersionString)
            throws MissingResourceException, UnexpectedInternalError {
        try {
            ...
            try {
                ...
                if (results.next()) {
                    ...
                    cs.setCodingSchemeName(ResourceManager.instance()
