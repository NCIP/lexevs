...
/**
 * Holder for the Intersect operation
 * 
...
public class Intersect implements SetOperation {
    ...
    private static final long serialVersionUID = -1988329439172813905L;
    private CodedNodeSetImpl codes_;

    public Intersect(CodedNodeSetImpl codes) throws LBParameterException {
        if (codes == null) {
            throw new LBParameterException("You must provide a CodedNodeSet to the intersect operation");
        }
        codes_ = codes;
    }
