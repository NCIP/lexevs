 ...
 */
public class DifferenceSingleLuceneIndexCodedNodeSet extends AbstractMultiSingleLuceneIndexCodedNodeSet {
    
    private static final long serialVersionUID = -5959522938971242708L;
    
    public DifferenceSingleLuceneIndexCodedNodeSet(){
        super();
    }

    public DifferenceSingleLuceneIndexCodedNodeSet(CodedNodeSetImpl cns1, CodedNodeSetImpl cns2) { 
        super(cns1,cns2);
    }
    ...
    protected CodeHolder handleToNodeListCodes(CodeHolder toNodeListCodes1, CodeHolder toNodeListCodes2) {
        ...
        newCodeHolder.difference(toNodeListCodes2);
