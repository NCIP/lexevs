...
public class DefaultDatabaseUtility extends JdbcDaoSupport implements DatabaseUtility {
	...
	public void executeScript(String creationScript) throws Exception {	
		creationScript = adjustForPrefix(creationScript);
		doExecuteScript(creationScript);
	}
	 ...
	 * @return the string
	 */
	protected String adjustForPrefix(String script){
		return script.replaceAll(PersistenceLayerConstants.PREFIX_PLACEHOLDER, prefix);
	}
	...
	public void truncateTable(String tableName)
			throws Exception {
		String sql = "TRUNCATE table " + prefix + tableName;
