 ...
 */
public class LexEvsPersistenceConnectionManager implements PersistenceConnectionManager{
	 ...
	 */
	public void createTables(SQLConnectionInfo connectionInfo, boolean createIndexes){
		try {	
