...
/**
 * The Class LoaderConstants.
 * 
 * @author <a href="mailto:kevin.peterson@mayo.edu">Kevin Peterson</a>
 */
public class LoaderConstants {
	
	/** The CONNECTIO n_ manager. */
	public static String CONNECTION_MANAGER = "CONNECTION_MANAGER";
	
	/** The SQ l_ connection. */
	public static String SQL_CONNECTION = "SQL_CONNECTION";
	
	/** The SOURC e_ dir. */
	public static String SOURCE_DIR = "SOURCE_DIR";

	/** The SOURC e_ qualifier. */
	public static String SOURCE_QUALIFIER = "source";
	
	/** The CODIN g_ schem e_ nam e_ property. */
	...
	/** The COPYRIGH t_ property. */
	public static String COPYRIGHT_PROPERTY = "Copyright";
	
	/** The ENTIT y_ descriptio n_ property. */
