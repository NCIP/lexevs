@echo off
 ...
 #
java -Xmx1000m -XX:PermSize=256m -cp ./lbTest.jar:../runtime/lbPatch.jar:../runtime/lbRuntime.jar:./extlib/ant/ant-1.7.0.jar:./extlib/ant/ant-junit-1.7.0.jar:./extlib/ant/ant-trax-1.7.0.jar:./extlib/ant/ant-launcher-1.7.0.jar:./extlib/junit/junit-4.4.jar bvt.TestRunner $@