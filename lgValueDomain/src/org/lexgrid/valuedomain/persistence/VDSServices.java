 ...
 */
public class VDSServices extends VDBaseService {

	private VDServices vdServices_;
	private VDMappingServices mappingServices_;

	protected VDSServices(JDBCBaseService anchorService)
			throws ServiceInitException {
		super(anchorService);
	}

	public VDSServices(HomeServiceBroker broker, JDBCConnectionDescriptor desc,
