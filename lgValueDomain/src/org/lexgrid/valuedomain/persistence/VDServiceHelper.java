...
public class VDServiceHelper {
	 ...
	 */
	public VDServiceHelper(String sqlServer, String sqlDriver,
	 ...
	 */
	private VDSServices getVDSService() throws ServiceInitException {
		if (vdss_ != null)
			return vdss_;
		...
		if (vdsContext_ != null)
			try {
				vdss_ = (VDSServices) broker.getService(vdsContext_);
		...
		if (vdss_ == null) {
			...
			vdss_ = new VDSServices(broker, desc, false, tablePrefix,
	 ...
	 * @throws ServiceInitException
	 */
	private VDServices getVDDefinitionService() throws ServiceInitException {
		if (vds_ != null)
			return vds_;
		...
		if (vdContext_ != null)
			try {
				vds_ = (VDServices) broker.getService(vdContext_);
			} catch (ServiceUnavailableException sue) {
			}
		if (vds_ == null) {
			JDBCConnectionDescriptor desc = new JDBCConnectionDescriptor();
			...
			vds_ = new VDServices(broker, desc, false, tablePrefix,
					failOnAllErrors, new MessageRedirector(md_), false);
	 ...
	 * @throws LBException
	 */
    public ResolvedValueDomainCodedNodeSet getResolvedCodedNodeSetForValueDomain(
	        ValueDomainDefinition vdd, AbsoluteCodingSchemeVersionReferenceList csVersionsToUse, String versionTag) 
	            throws LBException {
        ResolvedValueDomainCodedNodeSet rval = new ResolvedValueDomainCodedNodeSet();
     ...
     * @throws LBException
     */
    public VDServices getValueDomainServices() throws LBException {
        if (vds_ == null) {
            try {
     ...
     * @throws ServiceInitException
     */
    public VDSServices getValueDomainsServices() throws ServiceInitException {
        if (vdss_ == null) {
            vdss_ = getVDSService();
        }
        return vdss_;
     ...
     * @param vds
     */
    public void setValueDomainServices(VDServices vds) {
        this.vds_ = vds;
    }
     ...
     * @param vds
     */
    public void setValueDomainsServices(VDSServices vdss_) {
        this.vdss_ = vdss_;
    }
