 ...
 */
public class VDBaseSQLServices {
	...
	public VDBaseSQLServices(Connection sqlConnection, String tablePrefix)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public VDBaseSQLServices(GenericObjectPool connectionPool,
		...
		try {
			String createTable = gsm_
					.modifySQL("CREATE TABLE {IF NOT EXISTS} ^"
							+ VDConstants.TBL_VALUE_DOMAIN_TABLE_META_DATA
			...
			if (created) {
				...
				PreparedStatement tempInsert = conn
						.prepareStatement(gsm_
								.modifySQL(getInsertStatementSQL(VDConstants.TBL_VALUE_DOMAIN_TABLE_META_DATA)));
	...
	protected void incrementEntryId(int newEntryId) {
		...
		try {
			updateEntryIds = getKeyedUpdateStatement(VDConstants.TBL_ENTRY_IDS);
	...
	protected void insertEntryId(int newEntryId) {
		...
		try {
			insertEntryIds = getKeyedInsertStatement(VDConstants.TBL_ENTRY_IDS);
	...
	private void initTableCreateSQL() throws SQLException {
		...
		tableCreateSql_.put(VDConstants.TBL_VALUE_DOMAIN,
				"CREATE TABLE {IF NOT EXISTS} ^" + VDConstants.TBL_VALUE_DOMAIN
		...
		tableCreateSql_.put(VDConstants.TBL_VD_ENTRY,
				"CREATE TABLE {IF NOT EXISTS} ^" + VDConstants.TBL_VD_ENTRY
						+ "^ (" + " ^" + SQLTableConstants.TBLCOL_ENTRYID
						+ "^ {bigInt} NOT NULL," + " ^"
		...
		tableCreateSql_.put(VDConstants.TBL_PICK_LIST,
				"CREATE TABLE {IF NOT EXISTS} ^" + VDConstants.TBL_PICK_LIST
						+ "^ (" + " ^" + SQLTableConstants.TBLCOL_ENTRYID
						+ "^ {bigInt} NOT NULL," + " ^"
		...
		tableCreateSql_.put(VDConstants.TBL_PL_ENTRY,
				"CREATE TABLE {IF NOT EXISTS} ^" + VDConstants.TBL_PL_ENTRY
						+ "^ (" + " ^" + SQLTableConstants.TBLCOL_ENTRYID
						+ "^ {bigInt} NOT NULL," + " ^"
						+ SQLTableConstants.TBLCOL_FOREIGNENTRYID
						+ "^ {bigInt} NOT NULL," + " ^"
		...
		tableCreateSql_.put(VDConstants.TBL_MAPPING,
				"CREATE TABLE {IF NOT EXISTS} ^" + VDConstants.TBL_MAPPING
						+ "^ (" + " ^" + SQLTableConstants.TBLCOL_ENTRYID
						+ "^ {bigInt} NOT NULL," + " ^"
						+ SQLTableConstants.TBLCOL_FOREIGNENTRYID
						+ "^ {bigInt} NOT NULL," + " ^"
		...
		tableCreateSql_.put(VDConstants.TBL_PROPERTY,
				"CREATE TABLE {IF NOT EXISTS} ^" + VDConstants.TBL_PROPERTY
						+ "^ (" + " ^" + SQLTableConstants.TBLCOL_ENTRYID
						+ "^ {bigInt} NOT NULL," + " ^"
						+ SQLTableConstants.TBLCOL_FOREIGNENTRYID
						+ "^ {bigInt} NOT NULL," + " ^"
		...
		tableCreateSql_.put(VDConstants.TBL_ENTRY_TYPE,
				"CREATE TABLE {IF NOT EXISTS} ^" + VDConstants.TBL_ENTRY_TYPE
						+ "^ (" 
		...
		tableCreateSql_.put(VDConstants.TBL_ENTRY_STATE,
				"CREATE TABLE {IF NOT EXISTS} ^" + VDConstants.TBL_ENTRY_STATE
						+ "^ (" + " ^" + SQLTableConstants.TBLCOL_ENTRYSTATEID
						+ "^ {bigInt} NOT NULL," + " ^"
		...
		tableCreateSql_.put(VDConstants.TBL_ENTRY_IDS,
				"CREATE TABLE {IF NOT EXISTS} ^" + VDConstants.TBL_ENTRY_IDS
						+ "^ (" 
						+ " ^" + SQLTableConstants.TBLCOL_ENTRYID+ "^ {bigInt} NOT NULL," 
						+ " PRIMARY KEY  (^" + SQLTableConstants.TBLCOL_ENTRYID + "^)"
						+ ") {TYPE} {lgTableCharSet}");
		
		tableCreateSql_.put(VDConstants.TBL_SYSTEM_RELEASE,
				"CREATE TABLE {IF NOT EXISTS} ^" + VDConstants.TBL_SYSTEM_RELEASE
						+ "^ (" 
	...
	private void initIndexCreateSql() {
		...
		indexSql_.add("CREATE INDEX ^ivd1^ ON ^" + VDConstants.TBL_VALUE_DOMAIN
				+ "^ (^" + SQLTableConstants.TBLCOL_VALUEDOMAINURI + "^ ) ");

		indexSql_.add("CREATE INDEX ^ivd2^ ON ^" + VDConstants.TBL_VALUE_DOMAIN
				+ "^ (^" + SQLTableConstants.TBLCOL_VALUEDOMAINNAME + "^ ) ");

		indexSql_.add("CREATE INDEX ^ivde1^ ON ^" + VDConstants.TBL_VD_ENTRY
				+ "^ (^" + SQLTableConstants.TBLCOL_FOREIGNENTRYID + "^ ) ");
		
		indexSql_.add("CREATE INDEX ^ivde2^ ON ^" + VDConstants.TBL_VD_ENTRY
				+ "^ (^" + SQLTableConstants.TBLCOL_ENTITYCODE + "^ ) ");
		
		indexSql_.add("CREATE INDEX ^ipl1^ ON ^" + VDConstants.TBL_PICK_LIST
				+ "^ (^" + SQLTableConstants.TBLCOL_PICKLISTID + "^ ) ");

		indexSql_.add("CREATE INDEX ^ivpl2^ ON ^" + VDConstants.TBL_PICK_LIST
				+ "^ (^" + SQLTableConstants.TBLCOL_REPRESENTSVALUEDOMAIN + "^ ) ");

		indexSql_.add("CREATE INDEX ^iple1^ ON ^" + VDConstants.TBL_PL_ENTRY
				+ "^ (^" + SQLTableConstants.TBLCOL_FOREIGNENTRYID + "^ ) ");
		
		indexSql_.add("CREATE INDEX ^iple2^ ON ^" + VDConstants.TBL_PL_ENTRY
				+ "^ (^" + SQLTableConstants.TBLCOL_ENTITYCODE + "^ ) ");

		indexSql_.add("CREATE INDEX ^ip1^ ON ^" + VDConstants.TBL_PROPERTY
				+ "^ (^" + SQLTableConstants.TBLCOL_ENTRYID + "^, ^" 
				+ SQLTableConstants.TBLCOL_FOREIGNENTRYID + "^, ^"
				+ SQLTableConstants.TBLCOL_PROPERTYNAME + "^ ) ");

		indexSql_.add("CREATE INDEX ^ip2^ ON ^" + VDConstants.TBL_PROPERTY
				+ "^ (^" + SQLTableConstants.TBLCOL_FOREIGNENTRYID + "^ ) ");

		indexSql_.add("CREATE INDEX ^im1^ ON ^" + VDConstants.TBL_MAPPING
				+ "^ (^" + SQLTableConstants.TBLCOL_FOREIGNENTRYID + "^ ) ");
	}
	...
	private void initInsertStatements() {
		insertStatements_.put(VDConstants.TBL_VALUE_DOMAIN_TABLE_META_DATA,
				"INSERT INTO " + VDConstants.TBL_VALUE_DOMAIN_TABLE_META_DATA
						+ " (" + SQLTableConstants.TBLCOL_VERSION + ", "
						+ SQLTableConstants.TBLCOL_DESCRIPTION
						+ ") VALUES (?, ?)");

		// Value Domain tables
		insertStatements_.put(VDConstants.TBL_VALUE_DOMAIN, "INSERT INTO "
				+ VDConstants.TBL_VALUE_DOMAIN + " ("
				+ SQLTableConstants.TBLCOL_ENTRYID + ", "
				+ SQLTableConstants.TBLCOL_VALUEDOMAINURI + ", "
				+ SQLTableConstants.TBLCOL_VALUEDOMAINNAME + ", "
				+ SQLTableConstants.TBLCOL_DEFAULTCODINGSCHEME + ", "
		...
		insertStatements_.put(VDConstants.TBL_VD_ENTRY, "INSERT INTO "
				+ VDConstants.TBL_VD_ENTRY + " ("
				+ SQLTableConstants.TBLCOL_ENTRYID + ", "
				+ SQLTableConstants.TBLCOL_FOREIGNENTRYID + ", "
				+ SQLTableConstants.TBLCOL_ENTITYCODE + ", "
				+ SQLTableConstants.TBLCOL_ENTITYCODENAMESPACE + ", "
		...
		insertStatements_.put(VDConstants.TBL_PICK_LIST, "INSERT INTO "
				+ VDConstants.TBL_PICK_LIST + " ("
				+ SQLTableConstants.TBLCOL_ENTRYID + ", "
				+ SQLTableConstants.TBLCOL_PICKLISTID + ", "
				+ SQLTableConstants.TBLCOL_REPRESENTSVALUEDOMAIN + ", "
				+ SQLTableConstants.TBLCOL_COMPLETEDOMAIN + ", "
		...
		insertStatements_.put(VDConstants.TBL_PL_ENTRY, "INSERT INTO "
				+ VDConstants.TBL_PL_ENTRY + " ("
				+ SQLTableConstants.TBLCOL_ENTRYID + ", "
				+ SQLTableConstants.TBLCOL_FOREIGNENTRYID + ", "
				+ SQLTableConstants.TBLCOL_PLENTRYID + ", "
				+ SQLTableConstants.TBLCOL_ENTITYCODENAMESPACE + ", "
		...
		insertStatements_.put(VDConstants.TBL_ENTRY_TYPE, "INSERT INTO "
				+ VDConstants.TBL_ENTRY_TYPE + " ("
				+ SQLTableConstants.TBLCOL_REFERENCEENTRYID + ", "
				+ SQLTableConstants.TBLCOL_ENTRYTYPE + ") VALUES (?, ?)");

		insertStatements_.put(VDConstants.TBL_ENTRY_IDS, "INSERT INTO "
				+ VDConstants.TBL_ENTRY_IDS + " ("
				+ SQLTableConstants.TBLCOL_ENTRYID + ") VALUES (?)");

		insertStatements_.put(VDConstants.TBL_MAPPING, "INSERT INTO "
				+ VDConstants.TBL_MAPPING + " ("
				+ SQLTableConstants.TBLCOL_ENTRYID + ", "
				+ SQLTableConstants.TBLCOL_FOREIGNENTRYID + ", "
				+ SQLTableConstants.TBLCOL_SUPPORTEDATTRIBUTETAG + ", "
				+ SQLTableConstants.TBLCOL_LOCALID + ", "
		...
		insertStatements_.put(VDConstants.TBL_PROPERTY, "INSERT INTO "
				+ VDConstants.TBL_PROPERTY + " ("
				+ SQLTableConstants.TBLCOL_ENTRYID + ", "
				+ SQLTableConstants.TBLCOL_FOREIGNENTRYID + ", "
				+ SQLTableConstants.TBLCOL_PROPERTYNAME + ", "
				+ SQLTableConstants.TBLCOL_ISACTIVE + ", "
		...
		insertStatements_.put(VDConstants.TBL_ENTRY_STATE, "INSERT INTO "
				+ VDConstants.TBL_ENTRY_STATE + " ("
				+ SQLTableConstants.TBLCOL_ENTRYSTATEID + ", "
				+ SQLTableConstants.TBLCOL_ENTRYTYPE + ", "
				+ SQLTableConstants.TBLCOL_OWNER + ", "
				+ SQLTableConstants.TBLCOL_STATUS + ", "
		...
		insertStatements_.put(VDConstants.TBL_SYSTEM_RELEASE, "INSERT INTO "
				+ VDConstants.TBL_SYSTEM_RELEASE + " ("
				+ SQLTableConstants.TBLCOL_RELEASEURI + ", "
	...
	private void initUpdateSQL() {
		updateStatements_.put(VDConstants.TBL_ENTRY_IDS, "UPDATE "
				+ VDConstants.TBL_ENTRY_IDS + " SET "
				+ SQLTableConstants.TBLCOL_ENTRYID + " = ?");
	}
	...
	public boolean doValueDomainTablesExist() {
		return doesTableExist(VDConstants.TBL_VALUE_DOMAIN);
	}
	...
	public void dropValueDomainTables() throws SQLException {
		...
		if (doValueDomainTablesExist()) {
			...
			temp.add(VDConstants.TBL_ENTRY_STATE);
			temp.add(VDConstants.TBL_MAPPING);
			temp.add(VDConstants.TBL_PROPERTY);
			temp.add(VDConstants.TBL_PL_ENTRY);
			temp.add(VDConstants.TBL_PICK_LIST);
			temp.add(VDConstants.TBL_VD_ENTRY);
			temp.add(VDConstants.TBL_VALUE_DOMAIN);
			temp.add(VDConstants.TBL_ENTRY_TYPE);
			temp.add(VDConstants.TBL_ENTRY_IDS);
			temp.add(VDConstants.TBL_VALUE_DOMAIN_TABLE_META_DATA);
			temp.add(VDConstants.TBL_SYSTEM_RELEASE);
		}
	...
	private void initForeigKeyAlterSQL() {
		...
		foreignKeySql_.add("ALTER TABLE ^" + VDConstants.TBL_VALUE_DOMAIN
		...
		// vdEntry FKs -begin-
		foreignKeySql_.add("ALTER TABLE ^" + VDConstants.TBL_VD_ENTRY
		...
		// pickList FKs -begin-
		foreignKeySql_.add("ALTER TABLE ^" + VDConstants.TBL_PICK_LIST
		...
		// plEntry FKs -begin-
		foreignKeySql_.add("ALTER TABLE ^" + VDConstants.TBL_PL_ENTRY
		...
		foreignKeySql_.add("ALTER TABLE ^" + VDConstants.TBL_MAPPING
				+ "^ ADD CONSTRAINT ^fkmap1^ FOREIGN KEY (^"
				+ SQLTableConstants.TBLCOL_ENTRYID + "^) REFERENCES ^"
				+ VDConstants.TBL_ENTRY_TYPE + "^ (^"
				+ SQLTableConstants.TBLCOL_REFERENCEENTRYID + "^)");

		foreignKeySql_.add("ALTER TABLE ^" + VDConstants.TBL_PROPERTY
	...
	private void initDropValueDomainTableForeignKey() {
		...
		// pickList FKs -begin-
		dropForeignKeySql_.add("ALTER TABLE ^" + VDConstants.TBL_PICK_LIST
				+ "^ {DROPFOREIGNKEY} ^fkpl1^");
		// pickList FKs -end-

		// plEntry FKs -start-
		dropForeignKeySql_.add("ALTER TABLE ^" + VDConstants.TBL_PL_ENTRY
		...
		// valueDomain FKs -begin-
		dropForeignKeySql_.add("ALTER TABLE ^" + VDConstants.TBL_VALUE_DOMAIN
				+ "^ {DROPFOREIGNKEY} ^fkvd1^");
		// valueDomain FKs -end-

		// vdEntry FKs -begin-
		dropForeignKeySql_.add("ALTER TABLE ^" + VDConstants.TBL_VD_ENTRY
				+ "^ {DROPFOREIGNKEY} ^fkvde1^");
		dropForeignKeySql_.add("ALTER TABLE ^" + VDConstants.TBL_VD_ENTRY
				+ "^ {DROPFOREIGNKEY} ^fkvde2^");
		// vdEntry FKs -end-

		dropForeignKeySql_.add("ALTER TABLE ^" + VDConstants.TBL_MAPPING
				+ "^ {DROPFOREIGNKEY} ^fkmap1^");

		dropForeignKeySql_.add("ALTER TABLE ^" + VDConstants.TBL_PROPERTY
