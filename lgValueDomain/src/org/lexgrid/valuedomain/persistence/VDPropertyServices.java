 ...
 */
public class VDPropertyServices extends VDBaseService
{
	private VDEntryTypeServices entryTypeServices_;
	private VDEntryStateService entryStateServices_;
	
    public VDPropertyServices(JDBCBaseService anchorService) throws ServiceInitException
    {
        super(anchorService);
    }
    ...
    private void getPropQualsAndAttribs(Property currProperty, int entryId) throws FindException{
        ...
        try
        {
            ...
            selectFromProperty.setInt(1, entryId);
            selectFromProperty.setString(2, VDConstants.ENTRY_STATE_TYPE_ATTRIBUTE);
	...
	public void insert(ManagedObjIF obj) throws InsertException,
		...
		if (object instanceof PickListEntryNode ) {
			...
			String query = "SELECT " + SQLTableConstants.TBLCOL_ENTRYID
					+ " FROM " + VDConstants.TBL_PL_ENTRY + " WHERE "
    ...
    protected void initNestedServices() throws ServiceInitException
    {
        ...
        entryStateServices_ = new VDEntryStateService(this);
    }
	...
	public void removePropQualsAndAttribs(int entryId) throws FindException, SQLException{
        ...
        try
        {
        	...
        	selectPropQualsAndAttribsFromProperty.setString(2, VDConstants.ENTRY_STATE_TYPE_ATTRIBUTE);
        ...
        try
        {
        	...
        	deletePropQualsAndAttribsFromProperty = checkOutPreparedStatement(modifySql(
            		" DELETE FROM " + VDConstants.TBL_PROPERTY + 
            ...
            if (propEntryIds.size() > 0)
            {
            	entryTypeServices_.remove(propEntryIds, VDConstants.ENTRY_STATE_TYPE_ATTRIBUTE);            
            	propEntryIds.clear();
            }
        }
        finally
