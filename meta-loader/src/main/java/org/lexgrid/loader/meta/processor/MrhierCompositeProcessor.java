...
/**
 * The Class MrhierCompositeProcessor.
 * 
 * @author <a href="mailto:kevin.peterson@mayo.edu">Kevin Peterson</a>
 */
public class MrhierCompositeProcessor extends AbstractMrhierProcessor {
	...
	protected List<String> getPathToRoot(String pathToRoot) {
		...
		List<String> auis = this.getPathToRootAuis(pathToRoot);
		for(String aui : auis){

			ptr.add(mrconsoStagingDao.getCuiFromAui(aui));
		}
		return ptr;
	}
	...
	protected String getPropertyId(Mrhier mrhier, int pos) {
		return super.getAuiFromPos(mrhier, pos);
	}
