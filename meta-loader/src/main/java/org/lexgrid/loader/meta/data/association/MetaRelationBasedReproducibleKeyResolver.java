 ...
 * 
 */
package org.lexgrid.loader.meta.data.association;
...
import org.lexgrid.loader.rrf.processor.support.AuiResolver;
 ...
 */
public class MetaRelationBasedReproducibleKeyResolver<I> extends AbstractReproducibleKeyResolver<I> {
	...
	private AuiResolver<I> sourceAuiResolver;
	
	private AuiResolver<I> targetAuiResolver;
	...
	public String resolveMultiAttributesKey(I key) {
		...
		sourceAuiResolver.getAui(key),
		targetAuiResolver.getAui(key));
	}
	...
	public AuiResolver<I> getSourceAuiResolver() {
		return sourceAuiResolver;
	}

	public void setSourceAuiResolver(AuiResolver<I> sourceAuiResolver) {
		this.sourceAuiResolver = sourceAuiResolver;
	}

	public AuiResolver<I> getTargetAuiResolver() {
		return targetAuiResolver;
	}

	public void setTargetAuiResolver(AuiResolver<I> targetAuiResolver) {
		this.targetAuiResolver = targetAuiResolver;
	}
}
