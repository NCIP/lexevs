...
public class EntityTypeAddingEntityProcessor implements ItemProcessor<List<Mrconso>, List<Object>> {
	...
	private ItemProcessor<Entity, EntityType> entityTypeProcessor;
	...
	public List<Object> process(List<Mrconso> itemList) throws Exception {
		...
		EntityType entityType = entityTypeProcessor.process(entity);
	 ...
	 */
	public ItemProcessor<Entity, EntityType> getEntityTypeProcessor() {
	...
	public void setEntityTypeProcessor(
			ItemProcessor<Entity, EntityType> entityTypeProcessor) {
