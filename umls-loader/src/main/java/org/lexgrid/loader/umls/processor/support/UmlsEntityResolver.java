...
/**
 * The Class UmlsEntityResolver.
 * 
 * @author <a href="mailto:kevin.peterson@mayo.edu">Kevin Peterson</a>
 */
public class UmlsEntityResolver extends AbstractBasicEntityResolver<EntityProperty>{

	/* (non-Javadoc)
	 * @see org.lexgrid.loader.processor.support.EntityResolver#getIsActive(java.lang.Object)
	 */
	public boolean getIsActive(EntityProperty item) {	
		return true;
	}
	 ...
	 */
	public boolean getIsAnonymous(EntityProperty item) {
		return true;
	}
	 ...
	 */
	public boolean getIsDefined(EntityProperty item) {
		return true;
	}
}
