...
public class LexRdfMap {
	...
	private final static String OBO = OntologyType.OBO.toString() + "#";
	private final static String UMLS = OntologyType.UMLS.toString() + "#";
	...
	public static boolean isMapped(Entity entity, OntologyType ontType) {
		if (ontType.equals(OntologyType.OWLRDF)) {
	...
	public static boolean isMapped(String ns, String code, OntologyType ontType) {
		if (ontType.equals(OntologyType.OWLRDF)) {
