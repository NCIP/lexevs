 ...
 * 
 */
package org.lexgrid.exporter.owlrdf.admin;
...
import org.lexgrid.exporter.owlrdf.OwlRdfExporterImpl;

/**
 * Exports content from the repository to a file in OWL/RDF format.
 * 
 * <pre>
 * Example: java org.LexGrid.LexBIG.admin.ExportOwlRdf
 ...
 *   org.LexGrid.LexBIG.admin.ExportOwlRdf -out &quot;file:///path/to/dir&quot;
...
public class ExportOwlRdf {
    ...
    public void run(String[] args) throws Exception {
        synchronized (ResourceManager.instance()) {
            ...
            if (css == null) {
                if (urn != null || ver != null) {
                    Util.displayMessage("No matching coding scheme was found for the given URN or version: " + urn + " " + ver);
                    Util.displayMessage("");
                }
            ...
            // OwlRdf_Exporter exporter = (OwlRdf_Exporter)lbsm.getExporter(OwlRdfExporterImpl.name);
            OwlRdfExporterImpl exporter = new OwlRdfExporterImpl();
