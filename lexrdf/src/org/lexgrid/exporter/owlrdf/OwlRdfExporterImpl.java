...
import org.lexgrid.exporter.owlrdf.converter.LexGridToOwlRdfConverter;
import org.lexgrid.exporter.owlrdf.interfaces.OwlRdfExporter;
 ...
 */
public class OwlRdfExporterImpl extends BaseExporter implements OwlRdfExporter {
    ...
    public static void register() throws LBParameterException, LBException {
        ...
        temp.setExtensionBaseClass(OwlRdfExporter.class.getInterfaces()[0].getName());
        temp.setExtensionClass(OwlRdfExporter.class.getName());
    ...
    protected void exportCodingSchemeData(){
        ...
        converter.toTripleStore(codingScheme, cng, cns, out, this.getMessageDirector(), ontType)
    }
