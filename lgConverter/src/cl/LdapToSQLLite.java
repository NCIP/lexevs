...
/**
 * A Class to execute the LdapToSQLLite conversion from the command line.
 * 
...
public class LdapToSQLLite {
     ...
     * <pre>
     * 
     * usage: java -Xmx300 -cp convert.jar cl.LdapToSQLLite [-SU SQLUserName] 
     ...
     * 
     * 
     * Example: java -Xmx300 -cp convert.jar cl.LdapToSQLLite -SU user 
    ...
    public static void main(String[] args) throws Exception {
        ...
        new edu.mayo.informatics.lexgrid.convert.directConversions.LdapToSQLLite(options.getOptionValue("SS"), options
                ...
                .getOptionValue("LS"), options.getOptionValue("CS"), !options.hasOption("DC"), director);
