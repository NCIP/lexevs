...
public class SQLToLdap {
     ...
     * 
     * <pre>
     * usage: java -Xmx300 -cp convert.jar cl.SQLToLdap [-SU SQLUserName] 
     ...
     * 
     * 
     * Example: java -Xmx300 -cp convert.jar cl.SQLToLdap -SU user 
     * -SD sun.jdbc.odbc.JdbcOdbcDriver -SS &quot;jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=D:\Temp\LexGrid.mdb&quot; 
    ...
    public static void main(String[] args) throws Exception {
        ...
        new edu.mayo.informatics.lexgrid.convert.directConversions.SQLToLdap(options.getOptionValue("SS"), options
                .getOptionValue("SD"), options.getOptionValue("SU"), options.getOptionValue("SP"), options
                .getOptionValue("TP"), options.getOptionValue("LU"), options.getOptionValue("LP"), options
                .getOptionValue("LA"), options.getOptionValue("LS"), options.getOptionValue("CS"), !options
                .hasOption("IE"), director);
    ...
    private static CommandLine parseCommandLineOptions(String[] args) {
        ...
        try {
            ...
            formatter.printHelp(300, "java -Xmx300 -cp convert.jar cl.SQLToLdap", "", options, "", true);
            System.out.println("");
            System.out
                    .println("Example: java -Xmx300 -cp convert.jar cl.SQLToLdap -SU user -SD sun.jdbc.odbc.JdbcOdbcDriver -SS \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=D:\\Temp\\LexGrid.mdb\" -LA ldap://mir04.mayo.edu:31900 -LU cn=HL7User,dc=Users,service=userValidation,dc=LexGrid,dc=org -LP terminology -LS service=CTS,dc=LexGrid,dc=org -CS ActClass");
            System.exit(0);
        }
        return result;
    }
