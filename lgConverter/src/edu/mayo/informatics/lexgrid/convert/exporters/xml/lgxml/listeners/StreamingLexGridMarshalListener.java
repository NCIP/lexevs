...
public class StreamingLexGridMarshalListener implements MarshalListener 
{
	...
	public StreamingLexGridMarshalListener(Marshaller marshaller, CodedNodeGraph cng, CodedNodeSet cns, int pageSize, int limit) 
	{
	        this.setBlockSize(pageSize);
	        this.entitiesToReturn = limit;
	        this.marshaller = marshaller;
	...
	public boolean preMarshal(Object arg0) 
	{
	    ...
	    if(AssociationSource.class.equals(arg0.getClass()) == true) {
	        AssociationSource as = (AssociationSource)arg0;
		...
		*/
		/*
		    ...
		    AssociationPredicate ap = (AssociationPredicate)arg0;
		    System.out.println("marshal association predicate: " + ap.getAssociationName());
		}
		*/
		else {
	...
	private void processAssociationList(AssociationList _asl) throws MarshalException, ValidationException 
	{
		...
		if(localCurAssociationName == null){ return; }
