...
public class PreferenceManager {
    ...
    private String matchPattern_conceptCode = ProtegeOwl2EMFConstants.MATCH_CONCEPT_CODE;
    private String matchPattern_conceptStatus = ProtegeOwl2EMFConstants.MATCH_CONCEPT_STATUS;
    private String matchPattern_inactiveStatus = ProtegeOwl2EMFConstants.MATCH_INACTIVE_STATUS;
    private String matchPattern_noopNamespaces = ProtegeOwl2EMFConstants.MATCH_NOOP_NAMESPACES;
    private String matchPattern_rootName = ProtegeOwl2EMFConstants.MATCH_ROOT_NAME;
    private String matchPattern_xmlRepFormNames = ProtegeOwl2EMFConstants.MATCH_XMLREPFORM_NAMES;
    private String matchPattern_xmlSourceNames = ProtegeOwl2EMFConstants.MATCH_XMLSOURCE_NAMES;
    private String matchPattern_xmlTextNames = ProtegeOwl2EMFConstants.MATCH_XMLTEXT_NAMES;
    private List<String> prioritized_presentation_names = ProtegeOwl2EMFConstants.PRIORITIZED_PRESENTATION_NAMES;
    private List<String> prioritized_definition_names = ProtegeOwl2EMFConstants.PRIORITIZED_DEFINITION_NAMES;
    private List<String> prioritized_comment_names = ProtegeOwl2EMFConstants.PRIORITIZED_COMMENT_NAMES;
    private String propertyName_primitive = ProtegeOwl2EMFConstants.PROPNAME_PRIMITIVE;
    private String propertyName_type = ProtegeOwl2EMFConstants.PROPNAME_TYPE;
    private boolean processComplexProperties = ProtegeOwl2EMFConstants.PROCESS_COMPLEX_PROP;
    private boolean complexProps_isDbxRefSource = ProtegeOwl2EMFConstants.IS_DBXREF_SOURCE;
    private boolean complexProps_isDbxRefRepForm = ProtegeOwl2EMFConstants.IS_DBXREF_REPFORM;
    private boolean processStrictOWL = ProtegeOwl2EMFConstants.STRICT_OWL_IMPLEMENTATION;
    private boolean processConceptsForObjectProperties = ProtegeOwl2EMFConstants.CREATE_CONCEPT_FOR_OBJECT_PROP;
    private String dataTypePropertySwitch = ProtegeOwl2EMFConstants.DATATYPE_PROP_SWITCH;
