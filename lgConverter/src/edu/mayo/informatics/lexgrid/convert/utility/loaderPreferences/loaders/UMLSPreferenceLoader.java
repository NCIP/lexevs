...
/**
 * Class to load UMLS loader preferences from an XML file
 * 
...
public class UMLSPreferenceLoader extends BasePreferenceLoader implements PreferenceLoader {
    ...
    /**
     * Constructor for creating an UMLSPreferenceLoader. This class is used to
     * populate specific UMLS constants that will be used during the load
     * 
     * @param UMLSPreferences
     ...
     */
    public UMLSPreferenceLoader(URI UMLSPreferences, boolean validate) throws LgConvertException {
        if (validate) {
            if (validate(UMLSPreferences, ClassLoader.getSystemResource(PreferenceLoaderConstants.UMLS_XSD))) {
                prefs = UMLSPreferences;
            } else {
     ...
     */
    public UMLSPreferenceLoader(URI UMLSPreferences) throws LgConvertException {
        this(UMLSPreferences, false);
    }
    ...
    public boolean validate() {
        return super.validate(prefs, ClassLoader.getSystemResource(PreferenceLoaderConstants.UMLS_XSD));
    }
