...
public class PreferenceManager {
    ...
    private String matchPattern_conceptCode = ProtegeOwl2LGConstants.MATCH_CONCEPT_CODE;
    private String matchPattern_conceptStatus = ProtegeOwl2LGConstants.MATCH_CONCEPT_STATUS;
    private String matchPattern_inactiveStatus = ProtegeOwl2LGConstants.MATCH_INACTIVE_STATUS;
    private String matchPattern_noopNamespaces = ProtegeOwl2LGConstants.MATCH_NOOP_NAMESPACES;
    private String matchPattern_rootName = ProtegeOwl2LGConstants.MATCH_ROOT_NAME;
    private String matchPattern_xmlRepFormNames = ProtegeOwl2LGConstants.MATCH_XMLREPFORM_NAMES;
    ...
    private String propertyName_primitive = ProtegeOwl2LGConstants.PROPNAME_PRIMITIVE;
    private String propertyName_type = ProtegeOwl2LGConstants.PROPNAME_TYPE;
    private boolean processComplexProperties = ProtegeOwl2LGConstants.PROCESS_COMPLEX_PROP;
    private boolean complexProps_isDbxRefSource = ProtegeOwl2LGConstants.IS_DBXREF_SOURCE;
    private boolean complexProps_isDbxRefRepForm = ProtegeOwl2LGConstants.IS_DBXREF_REPFORM;
    private boolean processStrictOWL = ProtegeOwl2LGConstants.STRICT_OWL_IMPLEMENTATION;
    private boolean processConceptsForObjectProperties = ProtegeOwl2LGConstants.CREATE_CONCEPT_FOR_OBJECT_PROP;
    private String dataTypePropertySwitch = ProtegeOwl2LGConstants.DATATYPE_PROP_SWITCH;
