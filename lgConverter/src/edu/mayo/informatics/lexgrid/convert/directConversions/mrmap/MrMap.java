...
public class MrMap {
    ...
    public void setMapsetcui(String mapsetcui) {
        this.mapsetcui = mapsetcui;
    }
    public String getMapsab() {
        return mapsab;
    }
    public void setMapsab(String mapsab) {
        this.mapsab = mapsab;
    }
    ...
    public void setFromexpr(String fromexpr) {
...
public String mapid;
    ...
    /**
     * value of FROMID column from MRMAP.RRF
     */
    ...
    public String rela;    
    /**
     * value of TOID column from MRMAP.RRF
     */
    public String toid;   
    public String tosid;   
