...
public class LogViewerOptions {
    ...
    public LogViewerOptions(LogViewer logViewer, Shell parent) throws Exception {
        ...
        shell_ = new Shell(parent, SWT.DIALOG_TRIM | SWT.APPLICATION_MODAL | SWT.RESIZE | SWT.BORDER);
        shell_.setText("Converter Log Viewer Options");
        shell_.setSize(300, 180);
    ...
    private void buildComponents() {
        ...
        String[] temp = new String[] { "DEBUG", "INFO", "WARN", "ERROR", "FATAL" };
        ...
        ok_.addSelectionListener(new SelectionListener() {
            ...
            public void widgetSelected(SelectionEvent arg0) {
                for (int i = 0; i < logViewer_.logs_.length; i++) {
                    ...
                    logViewer_.logs_[i].level = (String) loggerLevels_[i].getText();
                }
        ...
        help_.addSelectionListener(new SelectionListener() {
            ...
            public void widgetSelected(SelectionEvent arg0) {
                MessageBox messageBox = new MessageBox(shell_, SWT.ICON_INFORMATION | SWT.OK);
                messageBox
