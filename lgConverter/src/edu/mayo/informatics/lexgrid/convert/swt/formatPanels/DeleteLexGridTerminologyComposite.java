 ...
 */
public class DeleteLexGridTerminologyComposite extends Composite {

    public DeleteLexGridTerminologyComposite(Composite parent, int style, String description, DialogHandler errorHandler) {
        super(parent, style);
        ...
        fileLabel.setText("This output format allows you to delete a terminology from the input server."
