@echo off
REM Exports content from the repository to a file in the LexGrid canonical
REM XML format.
REM
REM Options:
...
REM user selection.
REM
REM Example: ExportLgXML -out "file:///path/to/dir" -f
REM Example: ExportLgXML -out "file:///path/to/dir" -u "NCI_Thesaurus" -v "PRODUCTION" -f
REM
