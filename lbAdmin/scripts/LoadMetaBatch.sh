...
#
java -Xmx6000m -XX:PermSize=256m -Djava.awt.headless=true -cp "../runtime/lbPatch.jar:../runtime-components/extLib/*" org.lexgrid.loader.meta.launch.MetaBatchLoaderLauncher $@
