...
CREATE TABLE `@PREFIX@mrconsoStaging` (
  ...
  `SAUI` varchar(50) collate utf8_bin default NULL,
  `SCUI` varchar(50) collate utf8_bin default NULL,
  `SDUI` varchar(50) collate utf8_bin default NULL,
  `SAB` varchar(20) collate utf8_bin default NULL,
