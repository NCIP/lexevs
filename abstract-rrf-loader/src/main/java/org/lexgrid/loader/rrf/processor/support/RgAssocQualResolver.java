 ...
 */
public class RgAssocQualResolver extends AbstractAssociationQualifierResolver<Mrrel>{
	...
	public String getQualifierName(Mrrel item) {
		return RrfLoaderConstants.RG_QUALIFIER;
	}
	...
	public Text getQualifierValue(Mrrel item) {
		return DaoUtility.createText(item.getRg());
	}
}