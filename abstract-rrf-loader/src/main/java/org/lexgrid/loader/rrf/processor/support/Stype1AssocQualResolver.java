 ...
 */
public class Stype1AssocQualResolver extends AbstractAssociationQualifierResolver<Mrrel>{
	...
	public String getQualifierName(Mrrel item) {
		return RrfLoaderConstants.STYPE1_QUALIFIER;
	}
	...
	public Text getQualifierValue(Mrrel item) {
		return DaoUtility.createText(item.getStype1());
	}
}