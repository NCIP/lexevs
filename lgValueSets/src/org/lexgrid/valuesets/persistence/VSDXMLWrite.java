 ...
 */
public class VSDXMLWrite extends XMLWrite {
    private String xmlFolderLocation;
    private static Logger log = Logger.getLogger("convert.XMLReadWrite");
    private LgMessageDirectorIF messages_;
    private boolean overwrite_;

    public VSDXMLWrite(String xmlFolderLocation, boolean overwrite, boolean failOnAllErrors, LgMessageDirectorIF messages) {
    ...
    public static void main(String[] args){
    	...
    	VSDXMLWrite xmlWrite = new VSDXMLWrite("c:\\temp\\", true, true, new MessageDirector("VDExport", status));
