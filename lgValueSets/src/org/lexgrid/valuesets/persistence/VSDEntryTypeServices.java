 ...
 */
public class VSDEntryTypeServices extends VSDBaseService
{
	
    public VSDEntryTypeServices(JDBCBaseService anchorService) throws ServiceInitException
    {
        super(anchorService);
    }
    ...
    public void insert(String entryType, int entryId) throws InsertException, ObjectAlreadyExistsException
	{
		...
		try
		{
			insertIntoEntryState = getKeyedInsertStatement(VSDConstants.TBL_ENTRY_TYPE);
    ...
    public String resolveEntryTypeFor(int entryId) throws FindException
	{
		...
		try
		{
			selectFromEntryType = checkOutPreparedStatement(modifySql(
					...
					" FROM " + VSDConstants.TBL_ENTRY_TYPE + 
	...
	public void remove(ArrayList<Integer> entryIds, String entryType) throws ObjectNotFoundException
	{
		...
		sb.append("DELETE FROM " + VSDConstants.TBL_ENTRY_TYPE);
    ...
    {
        return VSDEntryTypeServices.class;
    }
}