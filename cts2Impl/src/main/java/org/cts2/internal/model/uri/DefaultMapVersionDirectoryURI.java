...
public class DefaultMapVersionDirectoryURI
	...
	private MapVersionDirectoryRestrictionState restrictionState = new MapVersionDirectoryRestrictionState(); //TODO double check MapVersionDirectoryRestrictionState
	...
	protected MapVersionDirectoryURI createSetOperatedDirectoryURI(
		...
		DefaultMapVersionDirectoryURI newUri = 
			new DefaultMapVersionDirectoryURI(
					this.lexBigService, 
					this.codingSchemeRenderingList, 
					this.getRestrictionHandler(), 
					this.beanMapper);
		
		newUri.getRestrictionState().setSetComposite(new SetComposite<MapVersionDirectoryURI>());
