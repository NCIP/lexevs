...
public class ResolvedConceptReferenceToAnonymousIndividualDescriptionTest extends
	...
	private AnonymousIndividualDescription mapped;
	...
	public void initialize() {
		...
		mapped = baseDozerBeanMapper.map(ref, AnonymousIndividualDescription.class);
