...
import org.cts2.internal.mapper.converter.AnonymousEntityDescriptionAboutConverter;
import org.cts2.internal.mapper.converter.AnonymousEntityDescriptionDefinitionListConverter;
import org.cts2.internal.mapper.converter.AnonymousEntityDescriptionDesignationListConverter;
import org.cts2.internal.mapper.converter.AnonymousEntityDescriptionNoteListConverter;
import org.cts2.internal.mapper.converter.AnonymousEntityDescriptionPropertyListConverter;
...
public class ResolvedConceptReferenceToAnonymousEntityDescriptionTest extends
		BaseDozerBeanMapperTest {
	private ResolvedConceptReference ref;
	private AnonymousEntityDescription mapped;
	
	@Resource
	private AnonymousEntityDescriptionAboutConverter anonymousEntityDescriptionAboutConverter;
	@Resource
	...
	@Resource
	private AnonymousEntityDescriptionPropertyListConverter anonymousEntityDescriptionPropertyListConverter;
	@Resource
	private AnonymousEntityDescriptionDesignationListConverter anonymousEntityDescriptionDesignationListConverter;
	@Resource
	private AnonymousEntityDescriptionDefinitionListConverter anonymousEntityDescriptionDefinitionListConverter;
	@Resource
	...
	public void initialize() {
		...
		this.anonymousEntityDescriptionAboutConverter.setCodingSchemeService(css);
		LexEvsIdentityConverter lexEvsIdentityConverter = new DefaultLexEvsIdentityConverter();
		this.anonymousEntityDescriptionAboutConverter
		...
		anonymousEntityDescriptionPropertyListConverter
				.setBaseDozerBeanMapper(baseDozerBeanMapper);
		anonymousEntityDescriptionPropertyListConverter.setCodingSchemeService(css);
		anonymousEntityDescriptionDesignationListConverter
				.setBaseDozerBeanMapper(baseDozerBeanMapper);
		anonymousEntityDescriptionDesignationListConverter
				.setCodingSchemeService(css);
		anonymousEntityDescriptionDefinitionListConverter
				.setBaseDozerBeanMapper(baseDozerBeanMapper);
		anonymousEntityDescriptionDefinitionListConverter
				.setCodingSchemeService(css);
		anonymousEntityDescriptionNoteListConverter
				.setBaseDozerBeanMapper(baseDozerBeanMapper);
		anonymousEntityDescriptionNoteListConverter.setCodingSchemeService(css);

		mapped = baseDozerBeanMapper.map(ref, AnonymousEntityDescription.class);
