...
public class RxnConstants {
	...
	/*
	public static String RXN_RELATIONS_NAME = "RXN_Relations";
	public static String RXN_RELATIONS_ENTITY_DESCRIPTION = "RXN-defined relationships (e.g. RB, RN, CHD, PAR)";
	*/
