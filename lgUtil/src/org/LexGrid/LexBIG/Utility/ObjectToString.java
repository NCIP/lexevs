...
public class ObjectToString {
            ...
            // superclass, etc, until one is found.
                ...
                try {
                    do {
                        try {
                            appendMethod =
                                ObjectToString.class.getDeclaredMethod("append",
                    ...
                    // Found?  Invoke now ...
                    if (appendMethod != null) {
                        appendMethod.invoke(ObjectToString.class, new Object[] {buff, indent, o});
                        added = true;
                    }
    ...
    protected static void append(StringBuffer buff, String indent, Property o) {
        buff.append(indent).append(getType(o))
            .append(getBreakAndIndent())
            .append("Name: ").append(o.getPropertyName())
            .append(getBreakAndIndent())
            .append("Identifier: " + o.getPropertyId())
            .append(getBreakAndIndent())
            .append("Value: ").append(lineBreak)
            .append(toString(o.getValue(), indent + sp8))
            .append(getBreakAndIndent())
            .append("Language: ").append(o.getLanguage());
        if (o.getSourceCount() > 0)
            buff.append(getBreakAndIndent())
                .append("Sources: ").append(lineBreak)
                .append(toString(o.getSource(), indent + sp8));
        if (o.getUsageContextCount() > 0)
            buff.append(getBreakAndIndent())
                .append("Usage Contexts").append(lineBreak)
                .append(toString(o.getUsageContext(), indent + sp8));
        if (o.getPropertyQualifierCount() > 0)
            buff.append(getBreakAndIndent())
                .append("Property Qualifiers").append(lineBreak)
    ...
    protected static void append(StringBuffer buff, String indent, PropertyQualifier o) {
        buff.append(indent).append(getType(o))
            .append(getBreakAndIndent())
            .append("Property Qualifier Name: ").append(o.getPropertyQualifierName())
            .append(getBreakAndIndent())
            .append("Value: ").append(lineBreak)
            .append(toString(o.getValue(), indent + sp8));
    }
    ...
    protected static void append(StringBuffer buff, String indent, Source o) {
        ...
        if (o.getRole() != null)
            buff.append(getBreakAndIndent())
                .append("Role: ").append(o.getRole());
        if (o.getSubRef() != null)
            buff.append(getBreakAndIndent())
                .append("Sub Ref: ").append(o.getSubRef());
    }
    ...
    protected static void append(StringBuffer buff, String indent, EntryState o) {
        buff.append(indent).append(getType(o))
            .append(getBreakAndIndent())
            .append("Change Type: ").append(o.getChangeType())
            .append(getBreakAndIndent())
            .append("Relative Order: ").append(o.getRelativeOrder())
            .append(getBreakAndIndent())
            .append("Containing Revision: ").append(o.getContainingRevision())
            .append(getBreakAndIndent())
            .append("Previous Revision: ").append(o.getPrevRevision());
    }
    
    protected static void append(StringBuffer buff, String indent, Revision o) {
        buff.append(indent).append(getType(o))
            .append(getBreakAndIndent())
            .append("Revision ID: ").append(o.getRevisionId())
            .append(getBreakAndIndent())
            .append("Edit Order: ").append(o.getEditOrder());
        if (o.getRevisionDate() != null)
            buff.append(getBreakAndIndent())
                .append("Revision Date: ").append(o.getRevisionDate());
        if (o.getEntityDescription() != null)
            buff.append(lineBreak)
                .append(toString(o.getEntityDescription(), indent + sp4));            
        if (o.getChangeInstructions() != null)
        ...
        if (o.getChangeAgent() != null)
            buff.append(getBreakAndIndent())
                .append("Change Agent: ").append(lineBreak)
                .append(toString(o.getChangeAgent(), indent + sp8));
        if (o.getChangedEntryCount() > 0)
            buff.append(getBreakAndIndent())
                .append("Change Entries: ").append(lineBreak)
    ...
    protected static void append(StringBuffer buff, String indent, SystemRelease o) {
        buff.append(indent).append(getType(o))
            .append(getBreakAndIndent())
            .append("Release ID: ").append(o.getReleaseId());
        if (o.getReleaseDate() != null)
            buff.append(getBreakAndIndent())
                .append("Release Date: " + mmddyyyy.format(o.getReleaseDate()));
        buff
            .append(getBreakAndIndent())
            .append("Release URI: ").append(o.getReleaseURI())
            .append(getBreakAndIndent())
            .append("Based on Release: ").append(o.getBasedOnRelease())
            .append(getBreakAndIndent())
            .append("Release Agency: ").append(o.getReleaseAgency());
        if (o.getEntityDescription() != null)
            buff.append(lineBreak)
                .append(toString(o.getEntityDescription(), indent + sp4));            
    }
    ...
    protected static void append(StringBuffer buff, String indent, DefinitionEntry o) {
        buff.append(indent).append(getType(o))
            ...
            .append("Choice Value: ").append(o.getChoiceValue())
            .append(getBreakAndIndent())
            .append("Operator: ").append(o.getOperator())
            .append(getBreakAndIndent())
            .append("Rule Order: ").append(o.getRuleOrder());
    ...
    protected static void append(StringBuffer buff, String indent, EntityReference o) {
        ...
        if (StringUtils.isNotBlank(o.getEntityCodeNamespace()))
            buff.append(getBreakAndIndent())
                .append("Code Namespace: ").append(o.getEntityCodeNamespace());
        if (StringUtils.isNotBlank(o.getReferenceAssociation()))
            buff.append(getBreakAndIndent())
                .append("Reference Association: ").append(o.getReferenceAssociation());
        buff
            .append(getBreakAndIndent())
            .append("Leaf Only: ").append(o.getLeafOnly())
            .append(getBreakAndIndent())
            .append("Target to Source: ").append(o.getTargetToSource())
            .append(getBreakAndIndent())
            .append("Transitive Closure: ").append(o.getTransitiveClosure());
    }
    ...
    protected static void append(StringBuffer buff, String indent, PickListEntry o) {
        buff.append(indent).append(getType(o))
            .append(getBreakAndIndent())
            .append("Pick Text: ").append(o.getPickText())
            .append(getBreakAndIndent())
            .append("Entry Order: ").append(o.getEntryOrder())
            .append(getBreakAndIndent())
            .append("Is Default: ").append(o.getIsDefault())
            .append(getBreakAndIndent())
            .append("Match No Context: ").append(o.getMatchIfNoContext());
        if (StringUtils.isNotBlank(o.getEntityCode()))
            buff.append(getBreakAndIndent())
                .append("Code: ").append(o.getEntityCode());
        if (StringUtils.isNotBlank(o.getEntityCodeNamespace()))
        ...
        if (StringUtils.isNotBlank(o.getPropertyId()))
            buff.append(getBreakAndIndent())
                .append("Property ID: ").append(o.getPropertyId());
        if (StringUtils.isNotBlank(o.getLanguage()))
            buff.append(getBreakAndIndent())
                .append("Language: ").append(o.getLanguage());
        if (o.getPickContextCount() > 0)
            buff.append(getBreakAndIndent())
                .append("Pick Contexts: ").append(lineBreak)
    ...
    protected static void append(StringBuffer buff, String indent, PickListEntryNode o) {
        append(buff, indent, (Versionable) o);
        buff.append(getBreakAndIndent())
            .append("Pick List Entry ID: ").append(o.getPickListEntryId());
        if (o.getPickListEntryNodeChoice() != null)
            buff.append(getBreakAndIndent())
                .append("Choice: ").append(lineBreak)
                .append(toString(o.getPickListEntryNodeChoice(), indent + sp8));
        if (o.getProperties() != null)
            buff.append(getBreakAndIndent())
                .append("Properties: ").append(lineBreak)
                .append(toString(o.getProperties(), indent + sp8));
    ...
    protected static void append(StringBuffer buff, String indent, ValueSetDefinition o) {
        ...
        if (o.getDefinitionEntryCount() > 0)
            buff.append(getBreakAndIndent())
                .append("Definitions: ").append(lineBreak)
                .append(toString(o.getDefinitionEntry(), indent + sp8));
        if (o.getRepresentsRealmOrContextCount() > 0)
            buff.append(getBreakAndIndent())
                .append("Represents Realm or Context: ").append(lineBreak)
    ...
    public static void main(String args[]) {
       ...
       System.out.println(ObjectToString.toString("Test", "  "));
       System.out.println(ObjectToString.toString(Boolean.FALSE, "  "));
       System.out.println(ObjectToString.toString(Boolean.FALSE.booleanValue(), "  "));
